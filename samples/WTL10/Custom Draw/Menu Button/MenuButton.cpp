// MenuButton.cpp : main source file for MenuButton.exe
//
...
//	HRESULT hRes = CoInitializeEx(NULL, COINIT_MULTITHREADED);
	...
	if(majorVersion < 6) {
		MessageBox(NULL, TEXT("This sample requires version 6.0 or newer of comctl32.dll."), TEXT("Error"), MB_ICONERROR | MB_OK);
		return IDABORT;
	}
	...
	hRes = _Module.Init(NULL, hInstance, &LIBID_BtnCtlsLibU);
	ATLASSERT(SUCCEEDED(hRes));
