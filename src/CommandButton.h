...
///
/// \if UNICODE
///   \sa BtnCtlsLibU::ICommandButton
/// \else
///   \sa BtnCtlsLibA::ICommandButton
/// \endif
//////////////////////////////////////////////////////////////////////
...
class ATL_NO_VTABLE CommandButton : 
    public CComObjectRootEx<CComSingleThreadModel>,
    #ifdef UNICODE
    	public IDispatchImpl<ICommandButton, &IID_ICommandButton, &LIBID_BtnCtlsLibU, /*wMajor =*/ VERSION_MAJOR, /*wMinor =*/ VERSION_MINOR>,
    #else
    	public IDispatchImpl<ICommandButton, &IID_ICommandButton, &LIBID_BtnCtlsLibA, /*wMajor =*/ VERSION_MAJOR, /*wMinor =*/ VERSION_MINOR>,
    #endif
    public IPersistStreamInitImpl<CommandButton>,
    public IOleControlImpl<CommandButton>,
    public IOleObjectImpl<CommandButton>,
    public IOleInPlaceActiveObjectImpl<CommandButton>,
    public IViewObjectExImpl<CommandButton>,
    public IOleInPlaceObjectWindowlessImpl<CommandButton>,
    public ISupportErrorInfo,
    public IConnectionPointContainerImpl<CommandButton>,
    public Proxy_ICommandButtonEvents<CommandButton>,
    public IPersistStorageImpl<CommandButton>,
    public IPersistPropertyBagImpl<CommandButton>,
    public ISpecifyPropertyPages,
    public IQuickActivateImpl<CommandButton>,
    #ifdef UNICODE
    	public IProvideClassInfo2Impl<&CLSID_CommandButton, &__uuidof(_ICommandButtonEvents), &LIBID_BtnCtlsLibU, /*wMajor =*/ VERSION_MAJOR, /*wMinor =*/ VERSION_MINOR>,
    #else
    	public IProvideClassInfo2Impl<&CLSID_CommandButton, &__uuidof(_ICommandButtonEvents), &LIBID_BtnCtlsLibA, /*wMajor =*/ VERSION_MAJOR, /*wMinor =*/ VERSION_MINOR>,
    #endif
    public IPropertyNotifySinkCP<CommandButton>,
    public CComCoClass<CommandButton, &CLSID_CommandButton>,
    public CComControl<CommandButton>,
    public IPerPropertyBrowsingImpl<CommandButton>,
    public IDropTarget,
...
public:
	...
	CommandButton();
		...
		DECLARE_OLEMISC_STATUS(OLEMISC_ACTIVATEWHENVISIBLE | OLEMISC_ACTSLIKEBUTTON | OLEMISC_ALIGNABLE | OLEMISC_INSIDEOUT | OLEMISC_RECOMPOSEONRESIZE | OLEMISC_SETCLIENTSITEFIRST)
		DECLARE_REGISTRY_RESOURCEID(IDR_COMMANDBUTTON)

		#ifdef UNICODE
			DECLARE_WND_SUPERCLASS(TEXT("CommandButtonU"), WC_BUTTONW)
		#else
			DECLARE_WND_SUPERCLASS(TEXT("CommandButtonA"), WC_BUTTONA)
		#endif
		...
		BEGIN_PROP_MAP(CommandButton)
			// NOTE: Don't forget to update Load and Save! This is for property bags only, not for streams!
			PROP_DATA_ENTRY("_cx", m_sizeExtent.cx, VT_UI4)
			PROP_DATA_ENTRY("_cy", m_sizeExtent.cy, VT_UI4)
			PROP_ENTRY_TYPE("Appearance", DISPID_CMDBTN_APPEARANCE, CLSID_NULL, VT_I4)
			PROP_ENTRY_TYPE("BackColor", DISPID_CMDBTN_BACKCOLOR, CLSID_StockColorPage, VT_I4)
			PROP_ENTRY_TYPE("BorderStyle", DISPID_CMDBTN_BORDERSTYLE, CLSID_NULL, VT_I4)
			PROP_ENTRY_TYPE("ButtonType", DISPID_CMDBTN_BUTTONTYPE, CLSID_NULL, VT_I4)
			//PROP_ENTRY_TYPE("CommandLinkNote", DISPID_CMDBTN_COMMANDLINKNOTE, CLSID_StringProperties, VT_BSTR)
			PROP_ENTRY_TYPE("ContentType", DISPID_CMDBTN_CONTENTTYPE, CLSID_NULL, VT_I4)
			PROP_ENTRY_TYPE("DisabledEvents", DISPID_CMDBTN_DISABLEDEVENTS, CLSID_NULL, VT_I4)
			PROP_ENTRY_TYPE("DontRedraw", DISPID_CMDBTN_DONTREDRAW, CLSID_NULL, VT_BOOL)
			PROP_ENTRY_TYPE("DropDownArrowHeight", DISPID_CMDBTN_DROPDOWNARROWHEIGHT, CLSID_NULL, VT_I4)
			PROP_ENTRY_TYPE("DropDownArrowWidth", DISPID_CMDBTN_DROPDOWNARROWWIDTH, CLSID_NULL, VT_I4)
			PROP_ENTRY_TYPE("DropDownGlyph", DISPID_CMDBTN_DROPDOWNGLYPH, CLSID_NULL, VT_I2)
			PROP_ENTRY_TYPE("DropDownOnRight", DISPID_CMDBTN_DROPDOWNONRIGHT, CLSID_NULL, VT_BOOL)
			PROP_ENTRY_TYPE("DropDownPushed", DISPID_CMDBTN_DROPDOWNPUSHED, CLSID_NULL, VT_BOOL)
			PROP_ENTRY_TYPE("DropDownStyle", DISPID_CMDBTN_DROPDOWNSTYLE, CLSID_NULL, VT_I4)
			PROP_ENTRY_TYPE("Enabled", DISPID_CMDBTN_ENABLED, CLSID_NULL, VT_BOOL)
			PROP_ENTRY_TYPE("Font", DISPID_CMDBTN_FONT, CLSID_StockFontPage, VT_DISPATCH)
			PROP_ENTRY_TYPE("ForeColor", DISPID_CMDBTN_FORECOLOR, CLSID_StockColorPage, VT_I4)
			PROP_ENTRY_TYPE("HAlignment", DISPID_CMDBTN_HALIGNMENT, CLSID_NULL, VT_I4)
			PROP_ENTRY_TYPE("HoverTime", DISPID_CMDBTN_HOVERTIME, CLSID_NULL, VT_I4)
			PROP_ENTRY_TYPE("IconAlignment", DISPID_CMDBTN_ICONALIGNMENT, CLSID_NULL, VT_I4)
			PROP_ENTRY_TYPE("IconMarginBottom", DISPID_CMDBTN_ICONMARGINBOTTOM, CLSID_NULL, VT_I4)
			PROP_ENTRY_TYPE("IconMarginLeft", DISPID_CMDBTN_ICONMARGINLEFT, CLSID_NULL, VT_I4)
			PROP_ENTRY_TYPE("IconMarginRight", DISPID_CMDBTN_ICONMARGINRIGHT, CLSID_NULL, VT_I4)
			PROP_ENTRY_TYPE("IconMarginTop", DISPID_CMDBTN_ICONMARGINTOP, CLSID_NULL, VT_I4)
			PROP_ENTRY_TYPE("KeepDropDownArrowAspectRatio", DISPID_CMDBTN_KEEPDROPDOWNARROWASPECTRATIO, CLSID_NULL, VT_BOOL)
			PROP_ENTRY_TYPE("MouseIcon", DISPID_CMDBTN_MOUSEICON, CLSID_StockPicturePage, VT_DISPATCH)
			PROP_ENTRY_TYPE("MousePointer", DISPID_CMDBTN_MOUSEPOINTER, CLSID_NULL, VT_I4)
			PROP_ENTRY_TYPE("MultiLine", DISPID_CMDBTN_MULTILINE, CLSID_NULL, VT_BOOL)
			PROP_ENTRY_TYPE("ProcessContextMenuKeys", DISPID_CMDBTN_PROCESSCONTEXTMENUKEYS, CLSID_NULL, VT_BOOL)
			PROP_ENTRY_TYPE("Pushed", DISPID_CMDBTN_PUSHED, CLSID_NULL, VT_BOOL)
			PROP_ENTRY_TYPE("RegisterForOLEDragDrop", DISPID_CMDBTN_REGISTERFOROLEDRAGDROP, CLSID_NULL, VT_BOOL)
			PROP_ENTRY_TYPE("RightToLeft", DISPID_CMDBTN_RIGHTTOLEFT, CLSID_NULL, VT_I4)
			PROP_ENTRY_TYPE("ShowRightsElevationIcon", DISPID_CMDBTN_SHOWRIGHTSELEVATIONICON, CLSID_NULL, VT_BOOL)
			PROP_ENTRY_TYPE("ShowSplitLine", DISPID_CMDBTN_SHOWSPLITLINE, CLSID_NULL, VT_BOOL)
			PROP_ENTRY_TYPE("Style", DISPID_CMDBTN_STYLE, CLSID_NULL, VT_I4)
			PROP_ENTRY_TYPE("SupportOLEDragImages", DISPID_CMDBTN_SUPPORTOLEDRAGIMAGES, CLSID_NULL, VT_BOOL)
			//PROP_ENTRY_TYPE("Text", DISPID_CMDBTN_TEXT, CLSID_StringProperties, VT_BSTR)
			PROP_ENTRY_TYPE("TextMarginBottom", DISPID_CMDBTN_TEXTMARGINBOTTOM, CLSID_NULL, VT_I4)
			PROP_ENTRY_TYPE("TextMarginLeft", DISPID_CMDBTN_TEXTMARGINLEFT, CLSID_NULL, VT_I4)
			PROP_ENTRY_TYPE("TextMarginRight", DISPID_CMDBTN_TEXTMARGINRIGHT, CLSID_NULL, VT_I4)
			PROP_ENTRY_TYPE("TextMarginTop", DISPID_CMDBTN_TEXTMARGINTOP, CLSID_NULL, VT_I4)
			PROP_ENTRY_TYPE("UseImprovedImageListSupport", DISPID_CMDBTN_USEIMPROVEDIMAGELISTSUPPORT, CLSID_NULL, VT_BOOL)
			PROP_ENTRY_TYPE("UseSystemFont", DISPID_CMDBTN_USESYSTEMFONT, CLSID_NULL, VT_BOOL)
			PROP_ENTRY_TYPE("VAlignment", DISPID_CMDBTN_VALIGNMENT, CLSID_NULL, VT_I4)
		END_PROP_MAP()

		BEGIN_CONNECTION_POINT_MAP(CommandButton)
			CONNECTION_POINT_ENTRY(IID_IPropertyNotifySink)
			CONNECTION_POINT_ENTRY(__uuidof(_ICommandButtonEvents))
		END_CONNECTION_POINT_MAP()

		BEGIN_MSG_MAP(CommandButton)
			...
			MESSAGE_HANDLER(BCM_SETDROPDOWNSTATE, OnSetDropDownState)
			MESSAGE_HANDLER(BCM_SETNOTE, OnSetNote)
			MESSAGE_HANDLER(BCM_SETSHIELD, OnSetShield)

			REFLECTED_NOTIFY_CODE_HANDLER(BCN_DROPDOWN, OnReflectedDropDown)
			...
			CHAIN_MSG_MAP(CComControl<CommandButton>)
	...
	//////////////////////////////////////////////////////////////////////
	/// \name Implementation of ICommandButton
	///
	//@{
	...
	///
	/// \if UNICODE
	///   \sa put_Appearance, get_BorderStyle, get_Style, get_ButtonType, BtnCtlsLibU::AppearanceConstants
	/// \else
	///   \sa put_Appearance, get_BorderStyle, get_Style, get_ButtonType, BtnCtlsLibA::AppearanceConstants
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa get_Appearance, put_BorderStyle, put_Style, put_ButtonType, BtnCtlsLibU::AppearanceConstants
	/// \else
	///   \sa get_Appearance, put_BorderStyle, put_Style, put_ButtonType, BtnCtlsLibA::AppearanceConstants
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa put_BorderStyle, get_Appearance, get_Style, get_ButtonType, BtnCtlsLibU::BorderStyleConstants
	/// \else
	///   \sa put_BorderStyle, get_Appearance, get_Style, get_ButtonType, BtnCtlsLibA::BorderStyleConstants
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa get_BorderStyle, put_Appearance, put_Style, put_ButtonType, BtnCtlsLibU::BorderStyleConstants
	/// \else
	///   \sa get_BorderStyle, put_Appearance, put_Style, put_ButtonType, BtnCtlsLibA::BorderStyleConstants
	/// \endif
	...
	///
	/// Retrieves the control's command button sub-type. Any of the values defined by the
	...
	///
	/// \if UNICODE
	///   \sa put_ButtonType, get_Appearance, get_BorderStyle, get_Style, BtnCtlsLibU::ButtonTypeConstants
	/// \else
	///   \sa put_ButtonType, get_Appearance, get_BorderStyle, get_Style, BtnCtlsLibA::ButtonTypeConstants
	/// \endif
	virtual HRESULT STDMETHODCALLTYPE get_ButtonType(ButtonTypeConstants* pValue);
	/// \brief <em>Sets the \c ButtonType property</em>
	///
	/// Sets the control's command button sub-type. Any of the values defined by the \c ButtonTypeConstants
	...
	///
	/// \if UNICODE
	///   \sa get_ButtonType, put_Appearance, put_BorderStyle, put_Style, BtnCtlsLibU::ButtonTypeConstants
	/// \else
	///   \sa get_ButtonType, put_Appearance, put_BorderStyle, put_Style, BtnCtlsLibA::ButtonTypeConstants
	/// \endif
	...
	/// \brief <em>Retrieves the current setting of the \c CommandLinkNote property</em>
	///
	/// Retrieves the text that is displayed below the button's caption if the \c ButtonType property is set
	/// to \c btCommandLink.
	///
	/// \param[out] pValue The property's current setting.
	///
	...
	/// \remarks Requires comctl32.dll version 6.10 or higher.
	///
	/// \sa put_CommandLinkNote, get_ButtonType, get_Text
	virtual HRESULT STDMETHODCALLTYPE get_CommandLinkNote(BSTR* pValue);
	/// \brief <em>Sets the \c CommandLinkNote property</em>
	///
	/// Sets the text that is displayed below the button's caption if the \c ButtonType property is set
	/// to \c btCommandLink.
	///
	/// \param[in] newValue The setting to apply.
	///
	...
	/// \remarks Requires comctl32.dll version 6.10 or higher.
	///
	/// \sa get_CommandLinkNote, put_ButtonType, put_Text
	virtual HRESULT STDMETHODCALLTYPE put_CommandLinkNote(BSTR newValue);
	...
	/// \brief <em>Retrieves the current setting of the \c DropDownArrowHeight property</em>
	///
	/// Retrieves the height (in pixels) of the drop-down part of a split button. If set to 0, the default
	/// height is used.
	///
	/// \param[out] pValue The property's current setting.
	///
	...
	/// \remarks Requires comctl32.dll version 6.10 or higher.
	///
	/// \sa put_DropDownArrowHeight, get_DropDownArrowWidth, get_ButtonType,
	///     get_KeepDropDownArrowAspectRatio, Raise_CustomDropDownAreaSize
	virtual HRESULT STDMETHODCALLTYPE get_DropDownArrowHeight(OLE_YSIZE_PIXELS* pValue);
	/// \brief <em>Sets the \c DropDownArrowHeight property</em>
	///
	/// Sets the height (in pixels) of the drop-down part of a split button. If set to 0, the default
	/// height is used.
	///
	/// \param[in] newValue The setting to apply.
	///
	...
	/// \remarks Requires comctl32.dll version 6.10 or higher.
	///
	/// \sa get_DropDownArrowHeight, put_DropDownArrowWidth, put_ButtonType,
	///     put_KeepDropDownArrowAspectRatio, Raise_CustomDropDownAreaSize
	virtual HRESULT STDMETHODCALLTYPE put_DropDownArrowHeight(OLE_YSIZE_PIXELS newValue);
	/// \brief <em>Retrieves the current setting of the \c DropDownArrowWidth property</em>
	///
	/// Retrieves the width (in pixels) of the drop-down part of a split button.
	///
	/// \param[out] pValue The property's current setting.
	///
	/// \return An \c HRESULT error code.
	...
	/// \remarks Requires comctl32.dll version 6.10 or higher.
	///
	/// \sa put_DropDownArrowWidth, get_DropDownArrowHeight, get_ButtonType,
	///     get_KeepDropDownArrowAspectRatio, Raise_CustomDropDownAreaSize
	virtual HRESULT STDMETHODCALLTYPE get_DropDownArrowWidth(OLE_XSIZE_PIXELS* pValue);
	/// \brief <em>Sets the \c DropDownArrowWidth property</em>
	///
	/// Sets the width (in pixels) of the drop-down part of a split button.
	///
	/// \param[in] newValue The setting to apply.
	///
	/// \return An \c HRESULT error code.
	...
	/// \remarks Requires comctl32.dll version 6.10 or higher.
	///
	/// \sa get_DropDownArrowWidth, put_DropDownArrowHeight, put_ButtonType,
	///     put_KeepDropDownArrowAspectRatio, Raise_CustomDropDownAreaSize
	virtual HRESULT STDMETHODCALLTYPE put_DropDownArrowWidth(OLE_XSIZE_PIXELS newValue);
	/// \brief <em>Retrieves the current setting of the \c DropDownGlyph property</em>
	///
	/// Retrieves the code of the character, that is displayed as drop-down arrow in a split button, if the
	/// \c DropDownStyle property is set to \c ddsGlyph.
	///
	/// \param[out] pValue The property's current setting.
	///
	/// \return An \c HRESULT error code.
	...
	/// \remarks Requires comctl32.dll version 6.10 or higher.
	///
	/// \sa put_DropDownGlyph, get_ButtonType, get_DropDownStyle, get_hDropDownImageList
	virtual HRESULT STDMETHODCALLTYPE get_DropDownGlyph(SHORT* pValue);
	/// \brief <em>Sets the \c DropDownGlyph property</em>
	///
	/// Sets the code of the character, that is displayed as drop-down arrow in a split button, if the
	/// \c DropDownStyle property is set to \c ddsGlyph.
	///
	/// \param[in] newValue The setting to apply.
	///
	...
	/// \remarks Requires comctl32.dll version 6.10 or higher.
	///
	/// \sa get_DropDownGlyph, put_ButtonType, put_DropDownStyle, put_hDropDownImageList
	virtual HRESULT STDMETHODCALLTYPE put_DropDownGlyph(SHORT newValue);
	/// \brief <em>Retrieves the current setting of the \c DropDownOnRight property</em>
	///
	/// Retrieves whether the drop-down part of a split button is drawn to the right of its caption. If set
	/// to \c VARIANT_TRUE, the separator is displayed to the right; otherwise to the left of the caption.
	///
	/// \param[out] pValue The property's current setting.
	///
	/// \return An \c HRESULT error code.
	...
	/// \remarks Requires comctl32.dll version 6.10 or higher.
	///
	/// \sa put_DropDownOnRight, get_ButtonType
	virtual HRESULT STDMETHODCALLTYPE get_DropDownOnRight(VARIANT_BOOL* pValue);
	/// \brief <em>Sets the \c DropDownOnRight property</em>
	///
	/// Sets whether the drop-down part of a split button is drawn to the right of its caption. If set
	/// to \c VARIANT_TRUE, the separator is displayed to the right; otherwise to the left of the caption.
	///
	/// \param[in] newValue The setting to apply.
	///
	...
	/// \remarks Requires comctl32.dll version 6.10 or higher.
	///
	/// \sa get_DropDownOnRight, put_ButtonType
	virtual HRESULT STDMETHODCALLTYPE put_DropDownOnRight(VARIANT_BOOL newValue);
	/// \brief <em>Retrieves the current setting of the \c DropDownPushed property</em>
	///
	/// Retrieves whether the drop-down part of a split button is drawn like being pushed. If set to
	/// \c VARIANT_TRUE, it is drawn like being pushed; otherwise not.
	///
	/// \param[out] pValue The property's current setting.
	///
	/// \return An \c HRESULT error code.
	...
	/// \remarks Requires comctl32.dll version 6.10 or higher.
	///
	/// \sa put_DropDownPushed, get_ButtonType, get_Pushed
	virtual HRESULT STDMETHODCALLTYPE get_DropDownPushed(VARIANT_BOOL* pValue);
	/// \brief <em>Sets the \c DropDownPushed property</em>
	///
	/// Sets whether the drop-down part of a split button is drawn like being pushed. If set to
	/// \c VARIANT_TRUE, it is drawn like being pushed; otherwise not.
	///
	/// \param[in] newValue The setting to apply.
	///
	...
	/// \remarks Requires comctl32.dll version 6.10 or higher.
	///
	/// \sa get_DropDownPushed, put_ButtonType, put_Pushed
	virtual HRESULT STDMETHODCALLTYPE put_DropDownPushed(VARIANT_BOOL newValue);
	/// \brief <em>Retrieves the current setting of the \c DropDownStyle property</em>
	///
	/// Retrieves which type of drop-down arrow to use in a split button. Any of the values defined by the
	/// \c DropDownStyleConstants enumeration is valid.
	///
	/// \param[out] pValue The property's current setting.
	///
	/// \return An \c HRESULT error code.
	...
	///
	/// \if UNICODE
	///   \sa put_DropDownStyle, get_ButtonType, get_DropDownGlyph, get_hDropDownImageList,
	///       BtnCtlsLibU::DropDownStyleConstants
	/// \else
	///   \sa put_DropDownStyle, get_ButtonType, get_DropDownGlyph, get_hDropDownImageList,
	///       BtnCtlsLibA::DropDownStyleConstants
	/// \endif
	...
	///
	/// Sets which type of drop-down arrow to use in a split button. Any of the values defined by the
	/// \c DropDownStyleConstants enumeration is valid.
	///
	/// \param[in] newValue The setting to apply.
	///
	...
	///
	/// \if UNICODE
	///   \sa get_DropDownStyle, put_ButtonType, put_DropDownGlyph, put_hDropDownImageList,
	///       BtnCtlsLibU::DropDownStyleConstants
	/// \else
	///   \sa get_DropDownStyle, put_ButtonType, put_DropDownGlyph, put_hDropDownImageList,
	///       BtnCtlsLibA::DropDownStyleConstants
	...
	/// \brief <em>Retrieves the current setting of the \c hDropDownImageList property</em>
	///
	/// Retrieves the handle to the imagelist containing the icons, that are displayed as drop-down arrow in
	/// a split button, if the \c DropDownStyle property is set to \c ddsImage. If set to NULL, no icon is
	/// drawn.\n
	...
	/// \remarks Requires comctl32.dll version 6.10 or higher.
	///
	/// \sa put_hDropDownImageList, get_hImageList, get_ButtonType, get_DropDownStyle, get_DropDownGlyph
	virtual HRESULT STDMETHODCALLTYPE get_hDropDownImageList(OLE_HANDLE* pValue);
	/// \brief <em>Sets the \c hDropDownImageList property</em>
	///
	/// Sets the handle to the imagelist containing the icons, that are displayed as drop-down arrow in
	/// a split button, if the \c DropDownStyle property is set to \c ddsImage. If set to NULL, no icon is
	/// drawn.\n
	/// The icon's index in the imagelist specifies the control state it is used for:
	/// - 0 - Used if the button is in no special state.
	...
	///
	/// \sa get_hDropDownImageList, put_hImageList, put_ButtonType, put_DropDownStyle, put_DropDownGlyph
	virtual HRESULT STDMETHODCALLTYPE put_hDropDownImageList(OLE_HANDLE newValue);
	...
	///
	/// \sa put_hImageList, get_hDropDownImageList, get_UseImprovedImageListSupport, get_IconIndex,
	///     get_Image, get_Text, get_IconAlignment, get_ShowRightsElevationIcon, GetIdealSize
	...
	///          The previously set image list does NOT get destroyed automatically.
	///
	/// \sa get_hImageList, put_hDropDownImageList, put_UseImprovedImageListSupport, put_IconIndex,
	///     put_Image, put_Text, put_IconAlignment, put_ShowRightsElevationIcon, GetIdealSize
	...
	/// \return An \c HRESULT error code.
	///
	/// \sa put_Image, get_ContentType, get_Text, get_hImageList, get_ShowRightsElevationIcon
	...
	///
	/// \sa get_Image, put_ContentType, put_Text, put_hImageList, put_ShowRightsElevationIcon
	...
	/// \brief <em>Retrieves the current setting of the \c KeepDropDownArrowAspectRatio property</em>
	///
	/// Retrieves whether the drop-down arrow of a split button is shrinked or stretched, so that its aspect
	/// ratio remains the same when changing the drop-down arrow's size. If set to \c VARIANT_TRUE, the
	/// aspect ratio remains the same; otherwise not.
	///
	/// \param[out] pValue The property's current setting.
	///
	/// \return An \c HRESULT error code.
	...
	/// \remarks Requires comctl32.dll version 6.10 or higher.
	///
	/// \sa put_KeepDropDownArrowAspectRatio, get_ButtonType, get_DropDownArrowHeight, get_DropDownArrowWidth
	virtual HRESULT STDMETHODCALLTYPE get_KeepDropDownArrowAspectRatio(VARIANT_BOOL* pValue);
	/// \brief <em>Sets the \c KeepDropDownArrowAspectRatio property</em>
	///
	/// Sets whether the drop-down arrow of a split button is shrinked or stretched, so that its aspect
	/// ratio remains the same when changing the drop-down arrow's size. If set to \c VARIANT_TRUE, the
	/// aspect ratio remains the same; otherwise not.
	///
	/// \param[in] newValue The setting to apply.
	...
	/// \remarks Requires comctl32.dll version 6.10 or higher.
	///
	/// \sa get_KeepDropDownArrowAspectRatio, put_ButtonType, put_DropDownArrowHeight, put_DropDownArrowWidth
	virtual HRESULT STDMETHODCALLTYPE put_KeepDropDownArrowAspectRatio(VARIANT_BOOL newValue);
	...
	///
	/// Retrieves whether the button is drawn like being pushed. If set to \c VARIANT_TRUE, it is drawn
	...
	///
	/// Sets whether the button is drawn like being pushed. If set to \c VARIANT_TRUE, it is drawn
	/// like being pushed; otherwise not.
	///
	/// \param[in] newValue The setting to apply.
	///
	...
	/// \brief <em>Retrieves the current setting of the \c ShowSplitLine property</em>
	///
	/// Retrieves whether the control displays an icon, which indicates, that clicking the control triggers
	/// an action, that requires elevated rights. If set to \c VARIANT_TRUE, the icon is displayed;
	/// otherwise not.
	///
	/// \param[out] pValue The property's current setting.
	///
	...
	/// \remarks Requires comctl32.dll version 6.10 or higher.
	///
	/// \sa put_ShowRightsElevationIcon, get_hImageList
	virtual HRESULT STDMETHODCALLTYPE get_ShowRightsElevationIcon(VARIANT_BOOL* pValue);
	/// \brief <em>Sets the \c ShowSplitLine property</em>
	///
	/// Sets whether the control displays an icon, which indicates, that clicking the control triggers
	/// an action, that requires elevated rights. If set to \c VARIANT_TRUE, the icon is displayed;
	/// otherwise not.
	///
	/// \param[in] newValue The setting to apply.
	...
	/// \remarks Requires comctl32.dll version 6.10 or higher.
	///
	/// \sa get_ShowRightsElevationIcon, put_hImageList
	virtual HRESULT STDMETHODCALLTYPE put_ShowRightsElevationIcon(VARIANT_BOOL newValue);
	/// \brief <em>Retrieves the current setting of the \c ShowSplitLine property</em>
	///
	/// Retrieves whether the two parts of a split button are visually separated by a line. If set to
	/// \c VARIANT_TRUE, the separator is displayed; otherwise not.
	///
	/// \param[out] pValue The property's current setting.
	///
	/// \return An \c HRESULT error code.
	...
	/// \remarks Requires comctl32.dll version 6.10 or higher.
	///
	/// \sa put_ShowSplitLine, get_ButtonType
	virtual HRESULT STDMETHODCALLTYPE get_ShowSplitLine(VARIANT_BOOL* pValue);
	/// \brief <em>Sets the \c ShowSplitLine property</em>
	///
	/// Sets whether the two parts of a split button are visually separated by a line. If set to
	/// \c VARIANT_TRUE, the separator is displayed; otherwise not.
	///
	/// \param[in] newValue The setting to apply.
	///
	...
	/// \remarks Requires comctl32.dll version 6.10 or higher.
	///
	/// \sa get_ShowSplitLine, put_ButtonType
	virtual HRESULT STDMETHODCALLTYPE put_ShowSplitLine(VARIANT_BOOL newValue);
	...
	///
	/// \if UNICODE
	///   \sa put_Style, get_Appearance, get_BorderStyle, get_ButtonType, BtnCtlsLibU::StyleConstants
	/// \else
	///   \sa put_Style, get_Appearance, get_BorderStyle, get_ButtonType, BtnCtlsLibA::StyleConstants
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa get_Style, put_Appearance, put_BorderStyle, put_ButtonType, BtnCtlsLibU::StyleConstants
	/// \else
	///   \sa get_Style, put_Appearance, put_BorderStyle, put_ButtonType, BtnCtlsLibA::StyleConstants
	/// \endif
	...
	/// \return An \c HRESULT error code.
	///
	/// \sa put_Text, get_CommandLinkNote, get_HAlignment, get_VAlignment, get_MultiLine, get_ForeColor,
	///     get_Font, get_ContentType, get_Image, get_hImageList, GetIdealSize
	...
	/// \return An \c HRESULT error code.
	///
	/// \sa get_Text, put_CommandLinkNote, put_HAlignment, put_VAlignment, put_MultiLine, put_ForeColor,
	///     put_Font, put_ContentType, put_Image, put_hImageList, GetIdealSize
	...
	///
	/// \if UNICODE
	///   \sa get_Pushed, BtnCtlsLibU::ControlStateConstants
	/// \else
	///   \sa get_Pushed, BtnCtlsLibA::ControlStateConstants
	/// \endif
...
protected:
	...
	/// \brief <em>\c WM_STYLECHANGING handler</em>
	///
	/// Will be called if the control's window style flags shall be changed.
	/// We use this handler for proper owner draw support. Visual Basic removes the \c BS_OWNERDRAW flag when
	/// setting the \c BS_DEFPUSHBUTTON flag.
	///
	/// \sa <a href="https://msdn.microsoft.com/en-us/library/ms632649.aspx">WM_STYLECHANGING</a>
	LRESULT OnStyleChanging(UINT /*message*/, WPARAM wParam, LPARAM lParam, BOOL& wasHandled);
	...
	/// We use this handler for the \c BackColor property.
	///
	/// \sa get_BackColor,
	...
	/// \brief <em>\c BCM_SETDROPDOWNSTATE handler</em>
	///
	/// Will be called when the control's \c DropDownPushed property shall be changed.
	/// We use this handler to synchronize our \c DropDownPushed settings.
	///
	/// \sa get_DropDownPushed, put_DropDownPushed,
	///     <a href="https://msdn.microsoft.com/en-us/library/aa361902.aspx">BCM_SETDROPDOWNSTATE</a>
	LRESULT OnSetDropDownState(UINT message, WPARAM wParam, LPARAM lParam, BOOL& /*wasHandled*/);
	/// \brief <em>\c BCM_SETNOTE handler</em>
	///
	/// Will be called when the control's \c CommandLinkNote property shall be changed.
	/// We use this handler to support data-binding for this property.
	///
	/// \sa get_CommandLinkNote, put_CommandLinkNote,
	///     <a href="https://msdn.microsoft.com/en-us/library/bb775977.aspx">BCM_SETNOTE</a>
	LRESULT OnSetNote(UINT message, WPARAM wParam, LPARAM lParam, BOOL& /*wasHandled*/);
	/// \brief <em>\c BCM_SETSHIELD handler</em>
	///
	/// Will be called when the control's \c ShowRightsElevationIcon property shall be changed.
	/// We use this handler to synchronize our \c ShowRightsElevationIcon settings.
	///
	/// \sa get_ShowRightsElevationIcon, put_ShowRightsElevationIcon,
	///     <a href="https://msdn.microsoft.com/en-us/library/aa361904.aspx">BCM_SETSHIELD</a>
	LRESULT OnSetShield(UINT message, WPARAM wParam, LPARAM lParam, BOOL& /*wasHandled*/);
	//@}
	//////////////////////////////////////////////////////////////////////
	...
	///
	//@{
	/// \brief <em>\c BCN_DROPDOWN handler</em>
	///
	/// Will be called if the control's parent window is notified, that the split button should display
	/// its drop-down menu.
	/// We use this handler for the \c DropDown feature.
	///
	/// \remarks This notification isn't sent, if the \c BCSS_NOSPLIT flag is used.
	///
	/// \sa Raise_DropDown,
	///     <a href="https://msdn.microsoft.com/en-us/library/aa361906.aspx">BCN_DROPDOWN</a>
	LRESULT OnReflectedDropDown(int /*controlID*/, LPNMHDR pNotificationDetails, BOOL& /*wasHandled*/);
	//@}
	//////////////////////////////////////////////////////////////////////
	...
	/// \brief <em>\c NM_GETCUSTOMSPLITRECT handler</em>
	///
	/// Will be called if the control's parent window is notified, that the bounding rectangle of the split
	/// button's drop-down area is required.
	/// We use this handler for the \c CustomDropDownAreaSize feature.
	///
	/// \remarks This notification isn't sent, if the \c BCSS_NOSPLIT flag is used.
	///
	/// \sa Raise_CustomDropDownAreaSize,
	///     <a href="https://msdn.microsoft.com/en-us/library/aa361886.aspx">NM_GETCUSTOMSPLITRECT</a>
	LRESULT OnGetCustomSplitRectNotification(UINT message, WPARAM wParam, LPARAM lParam, BOOL& /*wasHandled*/);
	...
	///
	/// \if UNICODE
	///   \sa Proxy_ICommandButtonEvents::Fire_Click, BtnCtlsLibU::_ICommandButtonEvents::Click,
	///       Raise_DblClick, Raise_MClick, Raise_RClick, Raise_XClick
	/// \else
	///   \sa Proxy_ICommandButtonEvents::Fire_Click, BtnCtlsLibA::_ICommandButtonEvents::Click,
	///       Raise_DblClick, Raise_MClick, Raise_RClick, Raise_XClick
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_ICommandButtonEvents::Fire_ContextMenu, BtnCtlsLibU::_ICommandButtonEvents::ContextMenu,
	///       Raise_RClick
	/// \else
	///   \sa Proxy_ICommandButtonEvents::Fire_ContextMenu, BtnCtlsLibA::_ICommandButtonEvents::ContextMenu,
	///       Raise_RClick
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_ICommandButtonEvents::Fire_CustomDraw, BtnCtlsLibU::_ICommandButtonEvents::CustomDraw,
	///       Raise_OwnerDraw, Raise_CustomDropDownAreaSize, BtnCtlsLibU::RECTANGLE,
	///       BtnCtlsLibU::CustomDrawStageConstants, BtnCtlsLibU::CustomDrawControlStateConstants,
	///       BtnCtlsLibU::CustomDrawReturnValuesConstants, get_DisabledEvents,
	///       <a href="https://msdn.microsoft.com/en-us/library/ms673590.aspx">NM_CUSTOMDRAW (button)</a>
	/// \else
	///   \sa Proxy_ICommandButtonEvents::Fire_CustomDraw, BtnCtlsLibA::_ICommandButtonEvents::CustomDraw,
	///       Raise_OwnerDraw, Raise_CustomDropDownAreaSize, BtnCtlsLibA::RECTANGLE,
	///       BtnCtlsLibA::CustomDrawStageConstants, BtnCtlsLibA::CustomDrawControlStateConstants,
	///       BtnCtlsLibA::CustomDrawReturnValuesConstants, get_DisabledEvents,
	///       <a href="https://msdn.microsoft.com/en-us/library/ms673590.aspx">NM_CUSTOMDRAW (button)</a>
	/// \endif
	...
	/// \brief <em>Raises the \c CustomDropDownAreaSize event</em>
	///
	...
	///
	/// \if UNICODE
	///   \sa Proxy_ICommandButtonEvents::Fire_CustomDropDownAreaSize,
	///       BtnCtlsLibU::_ICommandButtonEvents::CustomDropDownAreaSize, Raise_CustomDraw, get_ButtonType,
	///       get_DropDownArrowHeight, get_DropDownArrowWidth, BtnCtlsLibU::RECTANGLE,
	///       BtnCtlsLibU::CustomDropDownAreaSizeReturnValuesConstants, get_DisabledEvents
	/// \else
	///   \sa Proxy_ICommandButtonEvents::Fire_CustomDropDownAreaSize,
	///       BtnCtlsLibA::_ICommandButtonEvents::CustomDropDownAreaSize, Raise_CustomDraw, get_ButtonType,
	///       get_DropDownArrowHeight, get_DropDownArrowWidth, BtnCtlsLibA::RECTANGLE,
	///       BtnCtlsLibA::CustomDropDownAreaSizeReturnValuesConstants, get_DisabledEvents
	/// \endif
	inline HRESULT Raise_CustomDropDownAreaSize(RECTANGLE* pClientRectangle, RECTANGLE* pCommandButtonAreaRectangle, RECTANGLE* pDropDownAreaRectangle, CustomDropDownAreaSizeReturnValuesConstants* pFurtherProcessing);
	...
	///
	/// \if UNICODE
	///   \sa Proxy_ICommandButtonEvents::Fire_DblClick, BtnCtlsLibU::_ICommandButtonEvents::DblClick,
	///       Raise_Click, Raise_MDblClick, Raise_RDblClick, Raise_XDblClick
	/// \else
	///   \sa Proxy_ICommandButtonEvents::Fire_DblClick, BtnCtlsLibA::_ICommandButtonEvents::DblClick,
	///       Raise_Click, Raise_MDblClick, Raise_RDblClick, Raise_XDblClick
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_ICommandButtonEvents::Fire_DestroyedControlWindow,
	///       BtnCtlsLibU::_ICommandButtonEvents::DestroyedControlWindow, Raise_RecreatedControlWindow,
	///       get_hWnd
	/// \else
	///   \sa Proxy_ICommandButtonEvents::Fire_DestroyedControlWindow,
	///       BtnCtlsLibA::_ICommandButtonEvents::DestroyedControlWindow, Raise_RecreatedControlWindow,
	///       get_hWnd
	/// \endif
	...
	/// \return An \c HRESULT error code.
	///
	/// \remarks This event isn't raised, if the \c ShowSplitLine property is set to \c VARIANT_FALSE.\n
	///          Requires comctl32.dll version 6.10 or higher.
	///
	/// \if UNICODE
	///   \sa Proxy_ICommandButtonEvents::Fire_DropDown, BtnCtlsLibU::_ICommandButtonEvents::DropDown,
	///       Raise_Click, BtnCtlsLibU::RECTANGLE
	/// \else
	///   \sa Proxy_ICommandButtonEvents::Fire_DropDown, BtnCtlsLibA::_ICommandButtonEvents::DropDown,
	///       Raise_Click, BtnCtlsLibA::RECTANGLE
	/// \endif
	inline HRESULT Raise_DropDown(RECTANGLE* pButtonRectangle);
	...
	///
	/// \if UNICODE
	///   \sa Proxy_ICommandButtonEvents::Fire_KeyDown,
	///       BtnCtlsLibU::_ICommandButtonEvents::KeyDown, Raise_KeyUp, Raise_KeyPress
	/// \else
	///   \sa Proxy_ICommandButtonEvents::Fire_KeyDown,
	///       BtnCtlsLibA::_ICommandButtonEvents::KeyDown, Raise_KeyUp, Raise_KeyPress
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_ICommandButtonEvents::Fire_KeyPress,
	///       BtnCtlsLibU::_ICommandButtonEvents::KeyPress, Raise_KeyDown, Raise_KeyUp
	/// \else
	///   \sa Proxy_ICommandButtonEvents::Fire_KeyPress,
	///       BtnCtlsLibA::_ICommandButtonEvents::KeyPress, Raise_KeyDown, Raise_KeyUp
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_ICommandButtonEvents::Fire_KeyUp,
	///       BtnCtlsLibU::_ICommandButtonEvents::KeyUp, Raise_KeyDown, Raise_KeyPress
	/// \else
	///   \sa Proxy_ICommandButtonEvents::Fire_KeyUp,
	///       BtnCtlsLibA::_ICommandButtonEvents::KeyUp, Raise_KeyDown, Raise_KeyPress
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_ICommandButtonEvents::Fire_MClick, BtnCtlsLibU::_ICommandButtonEvents::MClick,
	///       Raise_MDblClick, Raise_Click, Raise_RClick, Raise_XClick
	/// \else
	///   \sa Proxy_ICommandButtonEvents::Fire_MClick, BtnCtlsLibA::_ICommandButtonEvents::MClick,
	///       Raise_MDblClick, Raise_Click, Raise_RClick, Raise_XClick
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_ICommandButtonEvents::Fire_MDblClick, BtnCtlsLibU::_ICommandButtonEvents::MDblClick,
	///       Raise_MClick, Raise_DblClick, Raise_RDblClick, Raise_XDblClick
	/// \else
	///   \sa Proxy_ICommandButtonEvents::Fire_MDblClick, BtnCtlsLibA::_ICommandButtonEvents::MDblClick,
	///       Raise_MClick, Raise_DblClick, Raise_RDblClick, Raise_XDblClick
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_ICommandButtonEvents::Fire_MouseDown, BtnCtlsLibU::_ICommandButtonEvents::MouseDown,
	///       Raise_MouseUp, Raise_Click, Raise_MClick, Raise_RClick, Raise_XClick
	/// \else
	///   \sa Proxy_ICommandButtonEvents::Fire_MouseDown, BtnCtlsLibA::_ICommandButtonEvents::MouseDown,
	///       Raise_MouseUp, Raise_Click, Raise_MClick, Raise_RClick, Raise_XClick
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_ICommandButtonEvents::Fire_MouseEnter, BtnCtlsLibU::_ICommandButtonEvents::MouseEnter,
	///       Raise_MouseLeave, Raise_MouseHover, Raise_MouseMove
	/// \else
	///   \sa Proxy_ICommandButtonEvents::Fire_MouseEnter, BtnCtlsLibA::_ICommandButtonEvents::MouseEnter,
	///       Raise_MouseLeave, Raise_MouseHover, Raise_MouseMove
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_ICommandButtonEvents::Fire_MouseHover, BtnCtlsLibU::_ICommandButtonEvents::MouseHover,
	///       Raise_MouseEnter, Raise_MouseLeave, Raise_MouseMove, put_HoverTime
	/// \else
	///   \sa Proxy_ICommandButtonEvents::Fire_MouseHover, BtnCtlsLibA::_ICommandButtonEvents::MouseHover,
	///       Raise_MouseEnter, Raise_MouseLeave, Raise_MouseMove, put_HoverTime
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_ICommandButtonEvents::Fire_MouseLeave, BtnCtlsLibU::_ICommandButtonEvents::MouseLeave,
	///       Raise_MouseEnter, Raise_MouseHover, Raise_MouseMove
	/// \else
	///   \sa Proxy_ICommandButtonEvents::Fire_MouseLeave, BtnCtlsLibA::_ICommandButtonEvents::MouseLeave,
	///       Raise_MouseEnter, Raise_MouseHover, Raise_MouseMove
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_ICommandButtonEvents::Fire_MouseMove, BtnCtlsLibU::_ICommandButtonEvents::MouseMove,
	///       Raise_MouseEnter, Raise_MouseLeave, Raise_MouseDown, Raise_MouseUp
	/// \else
	///   \sa Proxy_ICommandButtonEvents::Fire_MouseMove, BtnCtlsLibA::_ICommandButtonEvents::MouseMove,
	///       Raise_MouseEnter, Raise_MouseLeave, Raise_MouseDown, Raise_MouseUp
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_ICommandButtonEvents::Fire_MouseUp, BtnCtlsLibU::_ICommandButtonEvents::MouseUp,
	///       Raise_MouseDown, Raise_Click, Raise_MClick, Raise_RClick, Raise_XClick
	/// \else
	///   \sa Proxy_ICommandButtonEvents::Fire_MouseUp, BtnCtlsLibA::_ICommandButtonEvents::MouseUp,
	///       Raise_MouseDown, Raise_Click, Raise_MClick, Raise_RClick, Raise_XClick
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_ICommandButtonEvents::Fire_OLEDragDrop, BtnCtlsLibU::_ICommandButtonEvents::OLEDragDrop,
	...
	/// \else
	///   \sa Proxy_ICommandButtonEvents::Fire_OLEDragDrop, BtnCtlsLibA::_ICommandButtonEvents::OLEDragDrop,
	///       Raise_OLEDragEnter, Raise_OLEDragMouseMove, Raise_OLEDragLeave, Raise_MouseUp,
	///       get_RegisterForOLEDragDrop, FinishOLEDragDrop,
	///       <a href="https://msdn.microsoft.com/en-us/library/ms693457.aspx">DROPEFFECT</a>
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_ICommandButtonEvents::Fire_OLEDragEnter,
	///       BtnCtlsLibU::_ICommandButtonEvents::OLEDragEnter, Raise_OLEDragMouseMove, Raise_OLEDragLeave,
	///       Raise_OLEDragDrop, Raise_MouseEnter,
	///       <a href="https://msdn.microsoft.com/en-us/library/ms693457.aspx">DROPEFFECT</a>
	/// \else
	///   \sa Proxy_ICommandButtonEvents::Fire_OLEDragEnter,
	///       BtnCtlsLibA::_ICommandButtonEvents::OLEDragEnter, Raise_OLEDragMouseMove, Raise_OLEDragLeave,
	///       Raise_OLEDragDrop, Raise_MouseEnter,
	///       <a href="https://msdn.microsoft.com/en-us/library/ms693457.aspx">DROPEFFECT</a>
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_ICommandButtonEvents::Fire_OLEDragLeave,
	///       BtnCtlsLibU::_ICommandButtonEvents::OLEDragLeave, Raise_OLEDragEnter, Raise_OLEDragMouseMove,
	///       Raise_OLEDragDrop, Raise_MouseLeave
	/// \else
	///   \sa Proxy_ICommandButtonEvents::Fire_OLEDragLeave,
	///       BtnCtlsLibA::_ICommandButtonEvents::OLEDragLeave, Raise_OLEDragEnter, Raise_OLEDragMouseMove,
	///       Raise_OLEDragDrop, Raise_MouseLeave
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_ICommandButtonEvents::Fire_OLEDragMouseMove,
	///       BtnCtlsLibU::_ICommandButtonEvents::OLEDragMouseMove, Raise_OLEDragEnter,
	///       Raise_OLEDragLeave, Raise_OLEDragDrop, Raise_MouseMove,
	///       <a href="https://msdn.microsoft.com/en-us/library/ms693457.aspx">DROPEFFECT</a>
	/// \else
	///   \sa Proxy_ICommandButtonEvents::Fire_OLEDragMouseMove,
	///       BtnCtlsLibA::_ICommandButtonEvents::OLEDragMouseMove, Raise_OLEDragEnter,
	///       Raise_OLEDragLeave, Raise_OLEDragDrop, Raise_MouseMove,
	///       <a href="https://msdn.microsoft.com/en-us/library/ms693457.aspx">DROPEFFECT</a>
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_ICommandButtonEvents::Fire_OwnerDraw, BtnCtlsLibU::_ICommandButtonEvents::OwnerDraw,
	...
	/// \else
	///   \sa Proxy_ICommandButtonEvents::Fire_OwnerDraw, BtnCtlsLibA::_ICommandButtonEvents::OwnerDraw,
	...
	///
	/// \if UNICODE
	///   \sa Proxy_ICommandButtonEvents::Fire_RClick, BtnCtlsLibU::_ICommandButtonEvents::RClick,
	///       Raise_ContextMenu, Raise_RDblClick, Raise_Click, Raise_MClick, Raise_XClick
	/// \else
	///   \sa Proxy_ICommandButtonEvents::Fire_RClick, BtnCtlsLibA::_ICommandButtonEvents::RClick,
	///       Raise_ContextMenu, Raise_RDblClick, Raise_Click, Raise_MClick, Raise_XClick
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_ICommandButtonEvents::Fire_RDblClick, BtnCtlsLibU::_ICommandButtonEvents::RDblClick,
	///       Raise_RClick, Raise_DblClick, Raise_MDblClick, Raise_XDblClick
	/// \else
	///   \sa Proxy_ICommandButtonEvents::Fire_RDblClick, BtnCtlsLibA::_ICommandButtonEvents::RDblClick,
	///       Raise_RClick, Raise_DblClick, Raise_MDblClick, Raise_XDblClick
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_ICommandButtonEvents::Fire_RecreatedControlWindow,
	///       BtnCtlsLibU::_ICommandButtonEvents::RecreatedControlWindow, Raise_DestroyedControlWindow,
	///       get_hWnd
	/// \else
	///   \sa Proxy_ICommandButtonEvents::Fire_RecreatedControlWindow,
	///       BtnCtlsLibA::_ICommandButtonEvents::RecreatedControlWindow, Raise_DestroyedControlWindow,
	///       get_hWnd
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_ICommandButtonEvents::Fire_ResizedControlWindow,
	///       BtnCtlsLibU::_ICommandButtonEvents::ResizedControlWindow
	/// \else
	///   \sa Proxy_ICommandButtonEvents::Fire_ResizedControlWindow,
	///       BtnCtlsLibA::_ICommandButtonEvents::ResizedControlWindow
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_ICommandButtonEvents::Fire_XClick, BtnCtlsLibU::_ICommandButtonEvents::XClick,
	///       Raise_XDblClick, Raise_Click, Raise_MClick, Raise_RClick,
	///       BtnCtlsLibU::ExtendedMouseButtonConstants
	/// \else
	///   \sa Proxy_ICommandButtonEvents::Fire_XClick, BtnCtlsLibA::_ICommandButtonEvents::XClick,
	///       Raise_XDblClick, Raise_Click, Raise_MClick, Raise_RClick,
	///       BtnCtlsLibA::ExtendedMouseButtonConstants
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_ICommandButtonEvents::Fire_XDblClick, BtnCtlsLibU::_ICommandButtonEvents::XDblClick,
	///       Raise_XClick, Raise_DblClick, Raise_MDblClick, Raise_RDblClick,
	///       BtnCtlsLibU::ExtendedMouseButtonConstants
	/// \else
	///   \sa Proxy_ICommandButtonEvents::Fire_XDblClick, BtnCtlsLibA::_ICommandButtonEvents::XDblClick,
	///       Raise_XClick, Raise_DblClick, Raise_MDblClick, Raise_RDblClick,
	///       BtnCtlsLibA::ExtendedMouseButtonConstants
	/// \endif
	...
	/// \brief <em>Implementation of \c IOleControl::OnAmbientPropertyChange</em>
	///
	/// Will be called if one of the control container's ambient properties was changed.
	///
	/// \param[in] changedProperty The changed property's \c DISPID.
	///
	/// \return An \c HRESULT error code.
	///
	/// \sa <a href="https://msdn.microsoft.com/en-us/library/ms690175.aspx">IOleControl::OnAmbientPropertyChange</a>
	virtual HRESULT STDMETHODCALLTYPE OnAmbientPropertyChange(DISPID changedProperty);
	...
	typedef struct Properties
	{
		...
		public:
			...
			CComObject< PropertyNotifySinkImpl<CommandButton> >* pPropertyNotifySink;
			...
			HRESULT InitializePropertyWatcher(CommandButton* pObjectToNotify, DISPID propertyToWatch)
			{
				CComObject< PropertyNotifySinkImpl<CommandButton> >::CreateInstance(&pPropertyNotifySink);
		...
		/// \brief <em>Holds the \c ButtonType property's setting</em>
		///
		/// \sa get_ButtonType, put_ButtonType
		ButtonTypeConstants buttonType;
		/// \brief <em>Holds the \c CommandLinkNote property's setting</em>
		///
		/// \sa get_CommandLinkNote, put_CommandLinkNote
		CComBSTR commandLinkNote;
		...
		UINT dontRedraw : 1;
		/// \brief <em>Holds the \c DropDownArrowHeight property's setting</em>
		///
		/// \sa get_DropDownArrowHeight, put_DropDownArrowHeight
		OLE_YSIZE_PIXELS dropDownArrowHeight;
		/// \brief <em>Holds the \c DropDownArrowWidth property's setting</em>
		///
		/// \sa get_DropDownArrowWidth, put_DropDownArrowWidth
		OLE_XSIZE_PIXELS dropDownArrowWidth;
		/// \brief <em>Holds the \c DropDownGlyph property's setting</em>
		///
		/// \sa get_DropDownGlyph, put_DropDownGlyph
		WCHAR dropDownGlyph;
		/// \brief <em>Holds the \c DropDownOnRight property's setting</em>
		///
		/// \sa get_DropDownOnRight, put_DropDownOnRight
		UINT dropDownOnRight : 1;
		/// \brief <em>Holds the \c DropDownPushed property's setting</em>
		///
		/// \sa get_DropDownPushed, put_DropDownPushed
		UINT dropDownPushed : 1;
		/// \brief <em>Holds the \c DropDownStyle property's setting</em>
		///
		/// \sa get_DropDownStyle, put_DropDownStyle
		...
		/// \brief <em>Holds the \c hDropDownImageList property's setting</em>
		///
		/// \sa get_hDropDownImageList, put_hDropDownImageList
		HIMAGELIST hDropDownImageList;
		...
		HANDLE image;
		/// \brief <em>Holds the \c KeepDropDownArrowAspectRatio property's setting</em>
		///
		/// \sa get_KeepDropDownArrowAspectRatio, put_KeepDropDownArrowAspectRatio
		UINT keepDropDownArrowAspectRatio : 1;
		...
		/// \brief <em>Holds the \c ShowRightsElevationIcon property's setting</em>
		///
		/// \sa get_ShowRightsElevationIcon, put_ShowRightsElevationIcon
		UINT showRightsElevationIcon : 1;
		/// \brief <em>Holds the \c ShowSplitLine property's setting</em>
		///
		/// \sa get_ShowSplitLine, put_ShowSplitLine
		UINT showSplitLine : 1;
		...
		void ResetToDefaults(void)
		{
			...
			borderStyle = bsNone;
			buttonType = btCommandButton;
			commandLinkNote = L"";
			contentType = ctText;
			disabledEvents = static_cast<DisabledEventsConstants>(deMouseEvents | deKeyboardEvents | deCustomDraw | deCustomDropDownAreaSize);
			dontRedraw = FALSE;
			...
			iconMarginTop = 0;
			image = NULL;
			keepDropDownArrowAspectRatio = TRUE;
			...
			showRightsElevationIcon = FALSE;
			showSplitLine = TRUE;
			style = sNormal;
			supportOLEDragImages = TRUE;
			text = L"CommandButton";
			accelerator = L'\0';
			hAcceleratorTable = NULL;
...
OBJECT_ENTRY_AUTO(__uuidof(CommandButton), CommandButton)