...
///
/// \if UNICODE
///   \sa BtnCtlsLibU::IOptionButton
/// \else
///   \sa BtnCtlsLibA::IOptionButton
/// \endif
//////////////////////////////////////////////////////////////////////
...
#include "res/resource.h"
	...
	#include "BtnCtlsA.h"
#endif
#include "_IOptionButtonEvents_CP.h"
...
class ATL_NO_VTABLE OptionButton : 
    public CComObjectRootEx<CComSingleThreadModel>,
    #ifdef UNICODE
    	public IDispatchImpl<IOptionButton, &IID_IOptionButton, &LIBID_BtnCtlsLibU, /*wMajor =*/ VERSION_MAJOR, /*wMinor =*/ VERSION_MINOR>,
    #else
    	public IDispatchImpl<IOptionButton, &IID_IOptionButton, &LIBID_BtnCtlsLibA, /*wMajor =*/ VERSION_MAJOR, /*wMinor =*/ VERSION_MINOR>,
    #endif
    public IPersistStreamInitImpl<OptionButton>,
    public IOleControlImpl<OptionButton>,
    public IOleObjectImpl<OptionButton>,
    public IOleInPlaceActiveObjectImpl<OptionButton>,
    public IViewObjectExImpl<OptionButton>,
    public IOleInPlaceObjectWindowlessImpl<OptionButton>,
    public ISupportErrorInfo,
    public IConnectionPointContainerImpl<OptionButton>,
    public Proxy_IOptionButtonEvents<OptionButton>,
    public IPersistStorageImpl<OptionButton>,
    public IPersistPropertyBagImpl<OptionButton>,
    public ISpecifyPropertyPages,
    #ifdef UNICODE
    	public IProvideClassInfo2Impl<&CLSID_OptionButton, &__uuidof(_IOptionButtonEvents), &LIBID_BtnCtlsLibU, /*wMajor =*/ VERSION_MAJOR, /*wMinor =*/ VERSION_MINOR>,
    #else
    	public IProvideClassInfo2Impl<&CLSID_OptionButton, &__uuidof(_IOptionButtonEvents), &LIBID_BtnCtlsLibA, /*wMajor =*/ VERSION_MAJOR, /*wMinor =*/ VERSION_MINOR>,
    #endif
    public IPropertyNotifySinkCP<OptionButton>,
    public CComCoClass<OptionButton, &CLSID_OptionButton>,
    public CComControl<OptionButton>,
    public IPerPropertyBrowsingImpl<OptionButton>,
    public IDropTarget,
...
public:
	...
	OptionButton();
		...
		DECLARE_REGISTRY_RESOURCEID(IDR_OPTIONBUTTON)

		#ifdef UNICODE
			DECLARE_WND_SUPERCLASS(TEXT("OptionButtonU"), WC_BUTTONW)
		#else
			DECLARE_WND_SUPERCLASS(TEXT("OptionButtonA"), WC_BUTTONA)
		#endif
		...
		BEGIN_COM_MAP(OptionButton)
			COM_INTERFACE_ENTRY(IOptionButton)
		...
		BEGIN_PROP_MAP(OptionButton)
			// NOTE: Don't forget to update Load and Save! This is for property bags only, not for streams!
			PROP_DATA_ENTRY("_cx", m_sizeExtent.cx, VT_UI4)
			PROP_DATA_ENTRY("_cy", m_sizeExtent.cy, VT_UI4)
			PROP_ENTRY_TYPE("Appearance", DISPID_OPTBTN_APPEARANCE, CLSID_NULL, VT_I4)
			//PROP_ENTRY_TYPE("AutoToggleOption", DISPID_OPTBTN_AUTOTOGGLEOPTION, CLSID_NULL, VT_BOOL)
			PROP_ENTRY_TYPE("BackColor", DISPID_OPTBTN_BACKCOLOR, CLSID_StockColorPage, VT_I4)
			PROP_ENTRY_TYPE("BorderStyle", DISPID_OPTBTN_BORDERSTYLE, CLSID_NULL, VT_I4)
			PROP_ENTRY_TYPE("ContentType", DISPID_OPTBTN_CONTENTTYPE, CLSID_NULL, VT_I4)
			PROP_ENTRY_TYPE("DisabledEvents", DISPID_OPTBTN_DISABLEDEVENTS, CLSID_NULL, VT_I4)
			PROP_ENTRY_TYPE("DontRedraw", DISPID_OPTBTN_DONTREDRAW, CLSID_NULL, VT_BOOL)
			PROP_ENTRY_TYPE("Enabled", DISPID_OPTBTN_ENABLED, CLSID_NULL, VT_BOOL)
			PROP_ENTRY_TYPE("Font", DISPID_OPTBTN_FONT, CLSID_StockFontPage, VT_DISPATCH)
			PROP_ENTRY_TYPE("ForeColor", DISPID_OPTBTN_FORECOLOR, CLSID_StockColorPage, VT_I4)
			PROP_ENTRY_TYPE("HAlignment", DISPID_OPTBTN_HALIGNMENT, CLSID_NULL, VT_I4)
			PROP_ENTRY_TYPE("HoverTime", DISPID_OPTBTN_HOVERTIME, CLSID_NULL, VT_I4)
			PROP_ENTRY_TYPE("IconAlignment", DISPID_OPTBTN_ICONALIGNMENT, CLSID_NULL, VT_I4)
			PROP_ENTRY_TYPE("IconMarginBottom", DISPID_OPTBTN_ICONMARGINBOTTOM, CLSID_NULL, VT_I4)
			PROP_ENTRY_TYPE("IconMarginLeft", DISPID_OPTBTN_ICONMARGINLEFT, CLSID_NULL, VT_I4)
			PROP_ENTRY_TYPE("IconMarginRight", DISPID_OPTBTN_ICONMARGINRIGHT, CLSID_NULL, VT_I4)
			PROP_ENTRY_TYPE("IconMarginTop", DISPID_OPTBTN_ICONMARGINTOP, CLSID_NULL, VT_I4)
			PROP_ENTRY_TYPE("MouseIcon", DISPID_OPTBTN_MOUSEICON, CLSID_StockPicturePage, VT_DISPATCH)
			PROP_ENTRY_TYPE("MousePointer", DISPID_OPTBTN_MOUSEPOINTER, CLSID_NULL, VT_I4)
			PROP_ENTRY_TYPE("MultiLine", DISPID_OPTBTN_MULTILINE, CLSID_NULL, VT_BOOL)
			PROP_ENTRY_TYPE("OptionMarkOnRight", DISPID_OPTBTN_OPTIONMARKONRIGHT, CLSID_NULL, VT_BOOL)
			PROP_ENTRY_TYPE("ProcessContextMenuKeys", DISPID_OPTBTN_PROCESSCONTEXTMENUKEYS, CLSID_NULL, VT_BOOL)
			PROP_ENTRY_TYPE("Pushed", DISPID_OPTBTN_PUSHED, CLSID_NULL, VT_BOOL)
			PROP_ENTRY_TYPE("PushLike", DISPID_OPTBTN_PUSHLIKE, CLSID_NULL, VT_BOOL)
			PROP_ENTRY_TYPE("RegisterForOLEDragDrop", DISPID_OPTBTN_REGISTERFOROLEDRAGDROP, CLSID_NULL, VT_BOOL)
			PROP_ENTRY_TYPE("RightToLeft", DISPID_OPTBTN_RIGHTTOLEFT, CLSID_NULL, VT_I4)
			PROP_ENTRY_TYPE("Selected", DISPID_OPTBTN_SELECTED, CLSID_NULL, VT_BOOL)
			PROP_ENTRY_TYPE("Style", DISPID_OPTBTN_STYLE, CLSID_NULL, VT_I4)
			PROP_ENTRY_TYPE("SupportOLEDragImages", DISPID_OPTBTN_SUPPORTOLEDRAGIMAGES, CLSID_NULL, VT_BOOL)
			//PROP_ENTRY_TYPE("Text", DISPID_OPTBTN_TEXT, CLSID_StringProperties, VT_BSTR)
			PROP_ENTRY_TYPE("TextMarginBottom", DISPID_OPTBTN_TEXTMARGINBOTTOM, CLSID_NULL, VT_I4)
			PROP_ENTRY_TYPE("TextMarginLeft", DISPID_OPTBTN_TEXTMARGINLEFT, CLSID_NULL, VT_I4)
			PROP_ENTRY_TYPE("TextMarginRight", DISPID_OPTBTN_TEXTMARGINRIGHT, CLSID_NULL, VT_I4)
			PROP_ENTRY_TYPE("TextMarginTop", DISPID_OPTBTN_TEXTMARGINTOP, CLSID_NULL, VT_I4)
			PROP_ENTRY_TYPE("UseImprovedImageListSupport", DISPID_OPTBTN_USEIMPROVEDIMAGELISTSUPPORT, CLSID_NULL, VT_BOOL)
			PROP_ENTRY_TYPE("UseSystemFont", DISPID_OPTBTN_USESYSTEMFONT, CLSID_NULL, VT_BOOL)
			PROP_ENTRY_TYPE("VAlignment", DISPID_OPTBTN_VALIGNMENT, CLSID_NULL, VT_I4)
		END_PROP_MAP()

		BEGIN_CONNECTION_POINT_MAP(OptionButton)
			CONNECTION_POINT_ENTRY(IID_IPropertyNotifySink)
			CONNECTION_POINT_ENTRY(__uuidof(_IOptionButtonEvents))
		END_CONNECTION_POINT_MAP()

		BEGIN_MSG_MAP(OptionButton)
			...
			REFLECTED_COMMAND_CODE_HANDLER(BN_SETFOCUS, OnReflectedSetFocus)

			CHAIN_MSG_MAP(CComControl<OptionButton>)
	...
	//////////////////////////////////////////////////////////////////////
	/// \name Implementation of IOptionButton
	///
	//@{
	...
	// \brief <em>Retrieves the current setting of the \c AutoToggleOption property</em>
	//
	// Retrieves whether the option is selected automatically if the user clicks on the control. If set to
	// \c VARIANT_TRUE, it is changed automatically; otherwise not.
	//
	// \param[out] pValue The property's current setting.
	//
	// \return An \c HRESULT error code.
	//
	// \sa put_AutoToggleOption, get_Selected, Raise_Click
	//virtual HRESULT STDMETHODCALLTYPE get_AutoToggleOption(VARIANT_BOOL* pValue);
	// \brief <em>Sets the \c AutoToggleOption property</em>
	//
	// Sets whether the option is selected automatically if the user clicks on the control. If set to
	// \c VARIANT_TRUE, it is changed automatically; otherwise not.
	//
	// \param[in] newValue The setting to apply.
	//
	// \return An \c HRESULT error code.
	//
	// \sa get_AutoToggleOption, put_Selected, Raise_Click
	//virtual HRESULT STDMETHODCALLTYPE put_AutoToggleOption(VARIANT_BOOL newValue);*/
	...
	/// \brief <em>Retrieves the current setting of the \c OptionMarkOnRight property</em>
	///
	/// Retrieves whether the control's option mark is drawn to the right of the text specified by the
	...
	/// \return An \c HRESULT error code.
	///
	/// \sa put_OptionMarkOnRight, get_RightToLeft, get_Text
	virtual HRESULT STDMETHODCALLTYPE get_OptionMarkOnRight(VARIANT_BOOL* pValue);
	/// \brief <em>Sets the \c OptionMarkOnRight property</em>
	///
	/// Sets whether the control's option mark is drawn to the right of the text specified by the
	/// \c Text property. If set to \c VARIANT_TRUE, it is drawn to the right; otherwise to the left.
	///
	/// \param[in] newValue The setting to apply.
	///
	/// \return An \c HRESULT error code.
	///
	/// \sa get_OptionMarkOnRight, put_RightToLeft, put_Text
	virtual HRESULT STDMETHODCALLTYPE put_OptionMarkOnRight(VARIANT_BOOL newValue);
	...
	///
	/// Retrieves whether the option button is drawn like being pushed. If set to \c VARIANT_TRUE, it is
	...
	///
	/// Sets whether the option button is drawn like being pushed. If set to \c VARIANT_TRUE, it is drawn
	...
	///
	/// Retrieves whether the option button is drawn like a push button. If set to \c VARIANT_TRUE, it is
	...
	///
	/// Sets whether the option button is drawn like a push button. If set to \c VARIANT_TRUE, it is
	/// drawn like a push button; otherwise it is drawn like a common option button.
	///
	/// \param[in] newValue The setting to apply.
	///
	...
	///
	/// \if UNICODE
	///   \sa put_RightToLeft, get_OptionMarkOnRight, BtnCtlsLibU::RightToLeftConstants
	/// \else
	///   \sa put_RightToLeft, get_OptionMarkOnRight, BtnCtlsLibA::RightToLeftConstants
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa get_RightToLeft, put_OptionMarkOnRight, BtnCtlsLibU::RightToLeftConstants
	/// \else
	///   \sa get_RightToLeft, put_OptionMarkOnRight, BtnCtlsLibA::RightToLeftConstants
	/// \endif
	...
	///
	/// Retrieves whether the option represented by this option buttion is selected or not. If this property
	/// is set to \c VARIANT_TRUE, the option is selected; otherwise not.
	///
	/// \param[out] pValue The property's current setting.
	///
	/// \return An \c HRESULT error code.
	///
	// \sa put_Selected, get_AutoToggleOption, GetControlState, Raise_SelectionChanged
	/// \sa put_Selected, GetControlState, Raise_SelectionChanged
	virtual HRESULT STDMETHODCALLTYPE get_Selected(OLE_OPTEXCLUSIVE* pValue);
	/// \brief <em>Sets the \c Selected property</em>
	///
	/// Sets whether the option represented by this option buttion is selected or not. If this property
	/// is set to \c VARIANT_TRUE, the option is selected; otherwise not.
	///
	/// \param[in] newValue The setting to apply.
	///
	/// \return An \c HRESULT error code.
	///
	// \sa get_Selected, put_AutoToggleOption, GetControlState, Raise_SelectionChanged
	/// \sa get_Selected, GetControlState, Raise_SelectionChanged
	virtual HRESULT STDMETHODCALLTYPE put_Selected(OLE_OPTEXCLUSIVE newValue);
	...
	///
	/// \if UNICODE
	///   \sa get_Pushed, get_Selected, BtnCtlsLibU::ControlStateConstants
	/// \else
	///   \sa get_Pushed, get_Selected, BtnCtlsLibA::ControlStateConstants
	/// \endif
...
protected:
	...
	///
	/// \sa OnGetCheck, OnClicked, Raise_SelectionChanged,
	...
	/// We use this handler to raise the \c SelectionChanged and \c Click events.
	///
	/// \sa OnSetCheck, Raise_SelectionChanged, Raise_Click,
	...
	/// \brief <em>\c BN_SETFOCUS handler</em>
	///
	/// Will be called if the control's parent window is notified, that the control received the keyboard
	/// focus. We use this handler to select the option.
	///
	/// \sa <a href="https://msdn.microsoft.com/en-us/library/ms673587.aspx">BN_SETFOCUS</a>
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IOptionButtonEvents::Fire_Click, BtnCtlsLibU::_IOptionButtonEvents::Click,
	///       Raise_DblClick, Raise_MClick, Raise_RClick, Raise_XClick
	/// \else
	///   \sa Proxy_IOptionButtonEvents::Fire_Click, BtnCtlsLibA::_IOptionButtonEvents::Click,
	///       Raise_DblClick, Raise_MClick, Raise_RClick, Raise_XClick
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IOptionButtonEvents::Fire_ContextMenu, BtnCtlsLibU::_IOptionButtonEvents::ContextMenu,
	///       Raise_RClick
	/// \else
	///   \sa Proxy_IOptionButtonEvents::Fire_ContextMenu, BtnCtlsLibA::_IOptionButtonEvents::ContextMenu,
	///       Raise_RClick
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IOptionButtonEvents::Fire_CustomDraw, BtnCtlsLibU::_IOptionButtonEvents::CustomDraw,
	...
	///       <a href="https://msdn.microsoft.com/en-us/library/ms673590.aspx">NM_CUSTOMDRAW (button)</a>
	/// \else
	///   \sa Proxy_IOptionButtonEvents::Fire_CustomDraw, BtnCtlsLibA::_IOptionButtonEvents::CustomDraw,
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IOptionButtonEvents::Fire_DblClick, BtnCtlsLibU::_IOptionButtonEvents::DblClick,
	///       Raise_Click, Raise_MDblClick, Raise_RDblClick, Raise_XDblClick
	/// \else
	///   \sa Proxy_IOptionButtonEvents::Fire_DblClick, BtnCtlsLibA::_IOptionButtonEvents::DblClick,
	///       Raise_Click, Raise_MDblClick, Raise_RDblClick, Raise_XDblClick
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IOptionButtonEvents::Fire_DestroyedControlWindow,
	///       BtnCtlsLibU::_IOptionButtonEvents::DestroyedControlWindow, Raise_RecreatedControlWindow,
	///       get_hWnd
	/// \else
	///   \sa Proxy_IOptionButtonEvents::Fire_DestroyedControlWindow,
	///       BtnCtlsLibA::_IOptionButtonEvents::DestroyedControlWindow, Raise_RecreatedControlWindow,
	///       get_hWnd
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IOptionButtonEvents::Fire_KeyDown,
	///       BtnCtlsLibU::_IOptionButtonEvents::KeyDown, Raise_KeyUp, Raise_KeyPress
	/// \else
	///   \sa Proxy_IOptionButtonEvents::Fire_KeyDown,
	///       BtnCtlsLibA::_IOptionButtonEvents::KeyDown, Raise_KeyUp, Raise_KeyPress
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IOptionButtonEvents::Fire_KeyPress,
	///       BtnCtlsLibU::_IOptionButtonEvents::KeyPress, Raise_KeyDown, Raise_KeyUp
	/// \else
	///   \sa Proxy_IOptionButtonEvents::Fire_KeyPress,
	///       BtnCtlsLibA::_IOptionButtonEvents::KeyPress, Raise_KeyDown, Raise_KeyUp
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IOptionButtonEvents::Fire_KeyUp,
	///       BtnCtlsLibU::_IOptionButtonEvents::KeyUp, Raise_KeyDown, Raise_KeyPress
	/// \else
	///   \sa Proxy_IOptionButtonEvents::Fire_KeyUp,
	///       BtnCtlsLibA::_IOptionButtonEvents::KeyUp, Raise_KeyDown, Raise_KeyPress
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IOptionButtonEvents::Fire_MClick, BtnCtlsLibU::_IOptionButtonEvents::MClick,
	///       Raise_MDblClick, Raise_Click, Raise_RClick, Raise_XClick
	/// \else
	///   \sa Proxy_IOptionButtonEvents::Fire_MClick, BtnCtlsLibA::_IOptionButtonEvents::MClick,
	///       Raise_MDblClick, Raise_Click, Raise_RClick, Raise_XClick
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IOptionButtonEvents::Fire_MDblClick, BtnCtlsLibU::_IOptionButtonEvents::MDblClick,
	///       Raise_MClick, Raise_DblClick, Raise_RDblClick, Raise_XDblClick
	/// \else
	///   \sa Proxy_IOptionButtonEvents::Fire_MDblClick, BtnCtlsLibA::_IOptionButtonEvents::MDblClick,
	///       Raise_MClick, Raise_DblClick, Raise_RDblClick, Raise_XDblClick
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IOptionButtonEvents::Fire_MouseDown, BtnCtlsLibU::_IOptionButtonEvents::MouseDown,
	///       Raise_MouseUp, Raise_Click, Raise_MClick, Raise_RClick, Raise_XClick
	/// \else
	///   \sa Proxy_IOptionButtonEvents::Fire_MouseDown, BtnCtlsLibA::_IOptionButtonEvents::MouseDown,
	///       Raise_MouseUp, Raise_Click, Raise_MClick, Raise_RClick, Raise_XClick
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IOptionButtonEvents::Fire_MouseEnter, BtnCtlsLibU::_IOptionButtonEvents::MouseEnter,
	///       Raise_MouseLeave, Raise_MouseHover, Raise_MouseMove
	/// \else
	///   \sa Proxy_IOptionButtonEvents::Fire_MouseEnter, BtnCtlsLibA::_IOptionButtonEvents::MouseEnter,
	///       Raise_MouseLeave, Raise_MouseHover, Raise_MouseMove
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IOptionButtonEvents::Fire_MouseHover, BtnCtlsLibU::_IOptionButtonEvents::MouseHover,
	///       Raise_MouseEnter, Raise_MouseLeave, Raise_MouseMove, put_HoverTime
	/// \else
	///   \sa Proxy_IOptionButtonEvents::Fire_MouseHover, BtnCtlsLibA::_IOptionButtonEvents::MouseHover,
	///       Raise_MouseEnter, Raise_MouseLeave, Raise_MouseMove, put_HoverTime
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IOptionButtonEvents::Fire_MouseLeave, BtnCtlsLibU::_IOptionButtonEvents::MouseLeave,
	///       Raise_MouseEnter, Raise_MouseHover, Raise_MouseMove
	/// \else
	///   \sa Proxy_IOptionButtonEvents::Fire_MouseLeave, BtnCtlsLibA::_IOptionButtonEvents::MouseLeave,
	///       Raise_MouseEnter, Raise_MouseHover, Raise_MouseMove
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IOptionButtonEvents::Fire_MouseMove, BtnCtlsLibU::_IOptionButtonEvents::MouseMove,
	///       Raise_MouseEnter, Raise_MouseLeave, Raise_MouseDown, Raise_MouseUp
	/// \else
	///   \sa Proxy_IOptionButtonEvents::Fire_MouseMove, BtnCtlsLibA::_IOptionButtonEvents::MouseMove,
	///       Raise_MouseEnter, Raise_MouseLeave, Raise_MouseDown, Raise_MouseUp
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IOptionButtonEvents::Fire_MouseUp, BtnCtlsLibU::_IOptionButtonEvents::MouseUp,
	///       Raise_MouseDown, Raise_Click, Raise_MClick, Raise_RClick, Raise_XClick
	/// \else
	///   \sa Proxy_IOptionButtonEvents::Fire_MouseUp, BtnCtlsLibA::_IOptionButtonEvents::MouseUp,
	///       Raise_MouseDown, Raise_Click, Raise_MClick, Raise_RClick, Raise_XClick
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IOptionButtonEvents::Fire_OLEDragDrop, BtnCtlsLibU::_IOptionButtonEvents::OLEDragDrop,
	...
	/// \else
	///   \sa Proxy_IOptionButtonEvents::Fire_OLEDragDrop, BtnCtlsLibA::_IOptionButtonEvents::OLEDragDrop,
	///       Raise_OLEDragEnter, Raise_OLEDragMouseMove, Raise_OLEDragLeave, Raise_MouseUp,
	///       get_RegisterForOLEDragDrop, FinishOLEDragDrop,
	///       <a href="https://msdn.microsoft.com/en-us/library/ms693457.aspx">DROPEFFECT</a>
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IOptionButtonEvents::Fire_OLEDragEnter, BtnCtlsLibU::_IOptionButtonEvents::OLEDragEnter,
	///       Raise_OLEDragMouseMove, Raise_OLEDragLeave, Raise_OLEDragDrop, Raise_MouseEnter,
	///       <a href="https://msdn.microsoft.com/en-us/library/ms693457.aspx">DROPEFFECT</a>
	/// \else
	///   \sa Proxy_IOptionButtonEvents::Fire_OLEDragEnter, BtnCtlsLibA::_IOptionButtonEvents::OLEDragEnter,
	///       Raise_OLEDragMouseMove, Raise_OLEDragLeave, Raise_OLEDragDrop, Raise_MouseEnter,
	///       <a href="https://msdn.microsoft.com/en-us/library/ms693457.aspx">DROPEFFECT</a>
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IOptionButtonEvents::Fire_OLEDragLeave, BtnCtlsLibU::_IOptionButtonEvents::OLEDragLeave,
	///       Raise_OLEDragEnter, Raise_OLEDragMouseMove, Raise_OLEDragDrop, Raise_MouseLeave
	/// \else
	///   \sa Proxy_IOptionButtonEvents::Fire_OLEDragLeave, BtnCtlsLibA::_IOptionButtonEvents::OLEDragLeave,
	///       Raise_OLEDragEnter, Raise_OLEDragMouseMove, Raise_OLEDragDrop, Raise_MouseLeave
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IOptionButtonEvents::Fire_OLEDragMouseMove,
	///       BtnCtlsLibU::_IOptionButtonEvents::OLEDragMouseMove, Raise_OLEDragEnter,
	///       Raise_OLEDragLeave, Raise_OLEDragDrop, Raise_MouseMove,
	///       <a href="https://msdn.microsoft.com/en-us/library/ms693457.aspx">DROPEFFECT</a>
	/// \else
	///   \sa Proxy_IOptionButtonEvents::Fire_OLEDragMouseMove,
	///       BtnCtlsLibA::_IOptionButtonEvents::OLEDragMouseMove, Raise_OLEDragEnter,
	///       Raise_OLEDragLeave, Raise_OLEDragDrop, Raise_MouseMove,
	///       <a href="https://msdn.microsoft.com/en-us/library/ms693457.aspx">DROPEFFECT</a>
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IOptionButtonEvents::Fire_OwnerDraw, BtnCtlsLibU::_IOptionButtonEvents::OwnerDraw,
	...
	/// \else
	///   \sa Proxy_IOptionButtonEvents::Fire_OwnerDraw, BtnCtlsLibA::_IOptionButtonEvents::OwnerDraw,
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IOptionButtonEvents::Fire_RClick, BtnCtlsLibU::_IOptionButtonEvents::RClick,
	///       Raise_ContextMenu, Raise_RDblClick, Raise_Click, Raise_MClick, Raise_XClick
	/// \else
	///   \sa Proxy_IOptionButtonEvents::Fire_RClick, BtnCtlsLibA::_IOptionButtonEvents::RClick,
	///       Raise_ContextMenu, Raise_RDblClick, Raise_Click, Raise_MClick, Raise_XClick
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IOptionButtonEvents::Fire_RDblClick, BtnCtlsLibU::_IOptionButtonEvents::RDblClick,
	///       Raise_RClick, Raise_DblClick, Raise_MDblClick, Raise_XDblClick
	/// \else
	///   \sa Proxy_IOptionButtonEvents::Fire_RDblClick, BtnCtlsLibA::_IOptionButtonEvents::RDblClick,
	///       Raise_RClick, Raise_DblClick, Raise_MDblClick, Raise_XDblClick
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IOptionButtonEvents::Fire_RecreatedControlWindow,
	///       BtnCtlsLibU::_IOptionButtonEvents::RecreatedControlWindow, Raise_DestroyedControlWindow,
	///       get_hWnd
	/// \else
	///   \sa Proxy_IOptionButtonEvents::Fire_RecreatedControlWindow,
	///       BtnCtlsLibA::_IOptionButtonEvents::RecreatedControlWindow, Raise_DestroyedControlWindow,
	///       get_hWnd
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IOptionButtonEvents::Fire_ResizedControlWindow,
	///       BtnCtlsLibU::_IOptionButtonEvents::ResizedControlWindow
	/// \else
	///   \sa Proxy_IOptionButtonEvents::Fire_ResizedControlWindow,
	///       BtnCtlsLibA::_IOptionButtonEvents::ResizedControlWindow
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IOptionButtonEvents::Fire_SelectionChanged,
	///       BtnCtlsLibU::_IOptionButtonEvents::SelectionChanged, get_Selected
	/// \else
	///   \sa Proxy_IOptionButtonEvents::Fire_SelectionChanged,
	///       BtnCtlsLibA::_IOptionButtonEvents::SelectionChanged, get_Selected
	/// \endif
	inline HRESULT Raise_SelectionChanged(VARIANT_BOOL previousSelectionState, VARIANT_BOOL newSelectionState);
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IOptionButtonEvents::Fire_XClick, BtnCtlsLibU::_IOptionButtonEvents::XClick,
	///       Raise_XDblClick, Raise_Click, Raise_MClick, Raise_RClick,
	///       BtnCtlsLibU::ExtendedMouseButtonConstants
	/// \else
	///   \sa Proxy_IOptionButtonEvents::Fire_XClick, BtnCtlsLibA::_IOptionButtonEvents::XClick,
	///       Raise_XDblClick, Raise_Click, Raise_MClick, Raise_RClick,
	...
	///
	/// \if UNICODE
	///   \sa Proxy_IOptionButtonEvents::Fire_XDblClick, BtnCtlsLibU::_IOptionButtonEvents::XDblClick,
	///       Raise_XClick, Raise_DblClick, Raise_MDblClick, Raise_RDblClick,
	///       BtnCtlsLibU::ExtendedMouseButtonConstants
	/// \else
	///   \sa Proxy_IOptionButtonEvents::Fire_XDblClick, BtnCtlsLibA::_IOptionButtonEvents::XDblClick,
	///       Raise_XClick, Raise_DblClick, Raise_MDblClick, Raise_RDblClick,
	///       BtnCtlsLibA::ExtendedMouseButtonConstants
	/// \endif
	...
	///
	/// \sa LeaveNoMouseEventsSection, Flags::noMouseEvents, put_Selected, OnSetFocus
	void EnterNoMouseEventsSection(void);
	/// \brief <em>Decrements the \c noMouseEvents flag</em>
	///
	/// \sa EnterNoMouseEventsSection, Flags::noMouseEvents, put_Selected, OnSetFocus
	...
	typedef struct Properties
	{
		...
		public:
			...
			CComObject< PropertyNotifySinkImpl<OptionButton> >* pPropertyNotifySink;
			...
			HRESULT InitializePropertyWatcher(OptionButton* pObjectToNotify, DISPID propertyToWatch)
			{
				CComObject< PropertyNotifySinkImpl<OptionButton> >::CreateInstance(&pPropertyNotifySink);
		...
		// \brief <em>Holds the \c AutoToggleOption property's setting</em>
		//
		// \sa get_AutoToggleOption, put_AutoToggleOption
		//UINT autoToggleOption : 1;
		...
		UINT multiLine : 1;
		/// \brief <em>Holds the \c OptionMarkOnRight property's setting</em>
		///
		/// \sa get_OptionMarkOnRight, put_OptionMarkOnRight
		UINT optionMarkOnRight : 1;
		...
		/// \brief <em>Holds the \c Selected property's setting</em>
		///
		/// \sa get_Selected, put_Selected
		UINT selected : 1;
	...
	struct Flags
	{
		...
		///
		/// \sa OnClicked, Raise_SelectionChanged
...
OBJECT_ENTRY_AUTO(__uuidof(OptionButton), OptionButton)