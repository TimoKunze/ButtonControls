...
///
/// \if UNICODE
///   \sa BtnCtlsLibU::IOLEDataObject, CheckBox, CommandButton, Frame, OptionButton,
///       <a href="https://msdn.microsoft.com/en-us/library/ms688421.aspx">IDataObject</a>
/// \else
///   \sa BtnCtlsLibA::IOLEDataObject, CheckBox, CommandButton, Frame, OptionButton,
///       <a href="https://msdn.microsoft.com/en-us/library/ms688421.aspx">IDataObject</a>
/// \endif
//////////////////////////////////////////////////////////////////////
...
class ATL_NO_VTABLE TargetOLEDataObject : 
    ...
    #ifdef UNICODE
    	public IDispatchImpl<IOLEDataObject, &IID_IOLEDataObject, &LIBID_BtnCtlsLibU, /*wMajor =*/ VERSION_MAJOR, /*wMinor =*/ VERSION_MINOR>
    #else
    	public IDispatchImpl<IOLEDataObject, &IID_IOLEDataObject, &LIBID_BtnCtlsLibA, /*wMajor =*/ VERSION_MAJOR, /*wMinor =*/ VERSION_MINOR>
    #endif
{
...
public:
	...
	///
	/// \if UNICODE
	///   \sa SetDropDescription, CheckBox::get_SupportOLEDragImages,
	///       CommandButton::get_SupportOLEDragImages, Frame::get_SupportOLEDragImages,
	///       OptionButton::get_SupportOLEDragImages, BtnCtlsLibU::DropDescriptionIconConstants,
	///       <a href="https://msdn.microsoft.com/en-us/library/bb773268.aspx">DROPDESCRIPTION</a>
	/// \else
	///   \sa SetDropDescription, CheckBox::get_SupportOLEDragImages,
	///       CommandButton::get_SupportOLEDragImages, Frame::get_SupportOLEDragImages,
	///       OptionButton::get_SupportOLEDragImages, BtnCtlsLibA::DropDescriptionIconConstants,
	///       <a href="https://msdn.microsoft.com/en-us/library/bb773268.aspx">DROPDESCRIPTION</a>
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa GetDropDescription, CheckBox::put_SupportOLEDragImages,
	///       CommandButton::put_SupportOLEDragImages, Frame::put_SupportOLEDragImages,
	///       OptionButton::put_SupportOLEDragImages, BtnCtlsLibU::DropDescriptionIconConstants,
	///       <a href="https://msdn.microsoft.com/en-us/library/bb773268.aspx">DROPDESCRIPTION</a>
	/// \else
	///   \sa GetDropDescription, CheckBox::put_SupportOLEDragImages,
	///       CommandButton::put_SupportOLEDragImages, Frame::put_SupportOLEDragImages,
	///       OptionButton::put_SupportOLEDragImages, BtnCtlsLibA::DropDescriptionIconConstants,
	///       <a href="https://msdn.microsoft.com/en-us/library/bb773268.aspx">DROPDESCRIPTION</a>
	/// \endif
