//////////////////////////////////////////////////////////////////////
/// \class Proxy_IFrameEvents
/// \author Timo "TimoSoft" Kunze
/// \brief <em>Fires events specified by the \c _IFrameEvents interface</em>
///
/// \if UNICODE
///   \sa Frame, BtnCtlsLibU::_IFrameEvents
/// \else
///   \sa Frame, BtnCtlsLibA::_IFrameEvents
/// \endif
//////////////////////////////////////////////////////////////////////
...
class Proxy_IFrameEvents :
    public IConnectionPointImpl<TypeOfTrigger, &__uuidof(_IFrameEvents), CComDynamicUnkArray>
{
public:
	...
	///
	/// \if UNICODE
	///   \sa BtnCtlsLibU::_IFrameEvents::Click, Frame::Raise_Click, Fire_DblClick, Fire_MClick, Fire_RClick,
	///       Fire_XClick
	/// \else
	///   \sa BtnCtlsLibA::_IFrameEvents::Click, Frame::Raise_Click, Fire_DblClick, Fire_MClick, Fire_RClick,
	///       Fire_XClick
	/// \endif
	HRESULT Fire_Click(SHORT button, SHORT shift, OLE_XPOS_PIXELS x, OLE_YPOS_PIXELS y)
	{
		...
		for(int i = 0; i < m_vec.GetSize(); ++i) {
			...
			if(pConnection) {
				...
				hr = pConnection->Invoke(DISPID_FRME_CLICK, IID_NULL, LOCALE_USER_DEFAULT, DISPATCH_METHOD, &params, NULL, NULL, NULL);
			}
		}
		return hr;
	}
	...
	///
	/// \if UNICODE
	///   \sa BtnCtlsLibU::_IFrameEvents::ContextMenu, Frame::Raise_ContextMenu, Fire_RClick
	/// \else
	///   \sa BtnCtlsLibA::_IFrameEvents::ContextMenu, Frame::Raise_ContextMenu, Fire_RClick
	/// \endif
	HRESULT Fire_ContextMenu(SHORT button, SHORT shift, OLE_XPOS_PIXELS x, OLE_YPOS_PIXELS y)
	{
		...
		for(int i = 0; i < m_vec.GetSize(); ++i) {
			...
			if(pConnection) {
				...
				// invoke the event
				DISPPARAMS params = {p, NULL, 4, 0};
				hr = pConnection->Invoke(DISPID_FRME_CONTEXTMENU, IID_NULL, LOCALE_USER_DEFAULT, DISPATCH_METHOD, &params, NULL, NULL, NULL);
			}
		}
		return hr;
	}
	...
	///
	/// \if UNICODE
	///   \sa BtnCtlsLibU::_IFrameEvents::DblClick, Frame::Raise_DblClick, Fire_Click, Fire_MDblClick,
	///       Fire_RDblClick, Fire_XDblClick
	/// \else
	///   \sa BtnCtlsLibA::_IFrameEvents::DblClick, Frame::Raise_DblClick, Fire_Click, Fire_MDblClick,
	///       Fire_RDblClick, Fire_XDblClick
	/// \endif
	HRESULT Fire_DblClick(SHORT button, SHORT shift, OLE_XPOS_PIXELS x, OLE_YPOS_PIXELS y)
	{
		...
		for(int i = 0; i < m_vec.GetSize(); ++i) {
			...
			if(pConnection) {
				...
				// invoke the event
				DISPPARAMS params = {p, NULL, 4, 0};
				hr = pConnection->Invoke(DISPID_FRME_DBLCLICK, IID_NULL, LOCALE_USER_DEFAULT, DISPATCH_METHOD, &params, NULL, NULL, NULL);
			}
		}
		return hr;
	}
	...
	///
	/// \if UNICODE
	///   \sa BtnCtlsLibU::_IFrameEvents::DestroyedControlWindow,
	///       Frame::Raise_DestroyedControlWindow, Fire_RecreatedControlWindow
	/// \else
	///   \sa BtnCtlsLibA::_IFrameEvents::DestroyedControlWindow,
	///       Frame::Raise_DestroyedControlWindow, Fire_RecreatedControlWindow
	/// \endif
	HRESULT Fire_DestroyedControlWindow(LONG hWnd)
	{
		...
		for(int i = 0; i < m_vec.GetSize(); ++i) {
			...
			if(pConnection) {
				...
				hr = pConnection->Invoke(DISPID_FRME_DESTROYEDCONTROLWINDOW, IID_NULL, LOCALE_USER_DEFAULT, DISPATCH_METHOD, &params, NULL, NULL, NULL);
			}
		}
		return hr;
	}
	...
	///
	/// \if UNICODE
	///   \sa BtnCtlsLibU::_IFrameEvents::MClick, Frame::Raise_MClick, Fire_MDblClick, Fire_Click,
	///       Fire_RClick, Fire_XClick
	/// \else
	///   \sa BtnCtlsLibA::_IFrameEvents::MClick, Frame::Raise_MClick, Fire_MDblClick, Fire_Click,
	///       Fire_RClick, Fire_XClick
	/// \endif
	HRESULT Fire_MClick(SHORT button, SHORT shift, OLE_XPOS_PIXELS x, OLE_YPOS_PIXELS y)
	{
		...
		for(int i = 0; i < m_vec.GetSize(); ++i) {
			...
			if(pConnection) {
				...
				// invoke the event
				DISPPARAMS params = {p, NULL, 4, 0};
				hr = pConnection->Invoke(DISPID_FRME_MCLICK, IID_NULL, LOCALE_USER_DEFAULT, DISPATCH_METHOD, &params, NULL, NULL, NULL);
			}
		}
		return hr;
	}
	...
	///
	/// \if UNICODE
	///   \sa BtnCtlsLibU::_IFrameEvents::MDblClick, Frame::Raise_MDblClick, Fire_MClick, Fire_DblClick,
	///       Fire_RDblClick, Fire_XDblClick
	/// \else
	///   \sa BtnCtlsLibA::_IFrameEvents::MDblClick, Frame::Raise_MDblClick, Fire_MClick, Fire_DblClick,
	///       Fire_RDblClick, Fire_XDblClick
	/// \endif
	HRESULT Fire_MDblClick(SHORT button, SHORT shift, OLE_XPOS_PIXELS x, OLE_YPOS_PIXELS y)
	{
		...
		for(int i = 0; i < m_vec.GetSize(); ++i) {
			...
			if(pConnection) {
				...
				// invoke the event
				DISPPARAMS params = {p, NULL, 4, 0};
				hr = pConnection->Invoke(DISPID_FRME_MDBLCLICK, IID_NULL, LOCALE_USER_DEFAULT, DISPATCH_METHOD, &params, NULL, NULL, NULL);
			}
		}
		return hr;
	}
	...
	///
	/// \if UNICODE
	///   \sa BtnCtlsLibU::_IFrameEvents::MouseDown, Frame::Raise_MouseDown, Fire_MouseUp, Fire_Click,
	///       Fire_MClick, Fire_RClick, Fire_XClick
	/// \else
	///   \sa BtnCtlsLibA::_IFrameEvents::MouseDown, Frame::Raise_MouseDown, Fire_MouseUp, Fire_Click,
	///       Fire_MClick, Fire_RClick, Fire_XClick
	/// \endif
	HRESULT Fire_MouseDown(SHORT button, SHORT shift, OLE_XPOS_PIXELS x, OLE_YPOS_PIXELS y)
	{
		...
		for(int i = 0; i < m_vec.GetSize(); ++i) {
			...
			if(pConnection) {
				...
				// invoke the event
				DISPPARAMS params = {p, NULL, 4, 0};
				hr = pConnection->Invoke(DISPID_FRME_MOUSEDOWN, IID_NULL, LOCALE_USER_DEFAULT, DISPATCH_METHOD, &params, NULL, NULL, NULL);
			}
		}
		return hr;
	}
	...
	///
	/// \if UNICODE
	///   \sa BtnCtlsLibU::_IFrameEvents::MouseEnter, Frame::Raise_MouseEnter, Fire_MouseLeave,
	///       Fire_MouseHover, Fire_MouseMove
	/// \else
	///   \sa BtnCtlsLibA::_IFrameEvents::MouseEnter, Frame::Raise_MouseEnter, Fire_MouseLeave,
	///       Fire_MouseHover, Fire_MouseMove
	/// \endif
	HRESULT Fire_MouseEnter(SHORT button, SHORT shift, OLE_XPOS_PIXELS x, OLE_YPOS_PIXELS y)
	{
		...
		for(int i = 0; i < m_vec.GetSize(); ++i) {
			...
			if(pConnection) {
				...
				// invoke the event
				DISPPARAMS params = {p, NULL, 4, 0};
				hr = pConnection->Invoke(DISPID_FRME_MOUSEENTER, IID_NULL, LOCALE_USER_DEFAULT, DISPATCH_METHOD, &params, NULL, NULL, NULL);
			}
		}
		return hr;
	}
	...
	///
	/// \if UNICODE
	///   \sa BtnCtlsLibU::_IFrameEvents::MouseHover, Frame::Raise_MouseHover, Fire_MouseEnter,
	///       Fire_MouseLeave, Fire_MouseMove
	/// \else
	///   \sa BtnCtlsLibA::_IFrameEvents::MouseHover, Frame::Raise_MouseHover, Fire_MouseEnter,
	///       Fire_MouseLeave, Fire_MouseMove
	/// \endif
	HRESULT Fire_MouseHover(SHORT button, SHORT shift, OLE_XPOS_PIXELS x, OLE_YPOS_PIXELS y)
	{
		...
		for(int i = 0; i < m_vec.GetSize(); ++i) {
			...
			if(pConnection) {
				...
				// invoke the event
				DISPPARAMS params = {p, NULL, 4, 0};
				hr = pConnection->Invoke(DISPID_FRME_MOUSEHOVER, IID_NULL, LOCALE_USER_DEFAULT, DISPATCH_METHOD, &params, NULL, NULL, NULL);
			}
		}
		return hr;
	}
	...
	///
	/// \if UNICODE
	///   \sa BtnCtlsLibU::_IFrameEvents::MouseLeave, Frame::Raise_MouseLeave, Fire_MouseEnter,
	///       Fire_MouseHover, Fire_MouseMove
	/// \else
	///   \sa BtnCtlsLibA::_IFrameEvents::MouseLeave, Frame::Raise_MouseLeave, Fire_MouseEnter,
	///       Fire_MouseHover, Fire_MouseMove
	/// \endif
	HRESULT Fire_MouseLeave(SHORT button, SHORT shift, OLE_XPOS_PIXELS x, OLE_YPOS_PIXELS y)
	{
		...
		for(int i = 0; i < m_vec.GetSize(); ++i) {
			...
			if(pConnection) {
				...
				// invoke the event
				DISPPARAMS params = {p, NULL, 4, 0};
				hr = pConnection->Invoke(DISPID_FRME_MOUSELEAVE, IID_NULL, LOCALE_USER_DEFAULT, DISPATCH_METHOD, &params, NULL, NULL, NULL);
			}
		}
		return hr;
	}
	...
	///
	/// \if UNICODE
	///   \sa BtnCtlsLibU::_IFrameEvents::MouseMove, Frame::Raise_MouseMove, Fire_MouseEnter,
	///       Fire_MouseLeave, Fire_MouseDown, Fire_MouseUp
	/// \else
	///   \sa BtnCtlsLibA::_IFrameEvents::MouseMove, Frame::Raise_MouseMove, Fire_MouseEnter,
	///       Fire_MouseLeave, Fire_MouseDown, Fire_MouseUp
	/// \endif
	HRESULT Fire_MouseMove(SHORT button, SHORT shift, OLE_XPOS_PIXELS x, OLE_YPOS_PIXELS y)
	{
		...
		for(int i = 0; i < m_vec.GetSize(); ++i) {
			...
			if(pConnection) {
				...
				// invoke the event
				DISPPARAMS params = {p, NULL, 4, 0};
				hr = pConnection->Invoke(DISPID_FRME_MOUSEMOVE, IID_NULL, LOCALE_USER_DEFAULT, DISPATCH_METHOD, &params, NULL, NULL, NULL);
			}
		}
		return hr;
	}
	...
	///
	/// \if UNICODE
	///   \sa BtnCtlsLibU::_IFrameEvents::MouseUp, Frame::Raise_MouseUp, Fire_MouseDown, Fire_Click,
	///       Fire_MClick, Fire_RClick, Fire_XClick
	/// \else
	///   \sa BtnCtlsLibA::_IFrameEvents::MouseUp, Frame::Raise_MouseUp, Fire_MouseDown, Fire_Click,
	///       Fire_MClick, Fire_RClick, Fire_XClick
	/// \endif
	HRESULT Fire_MouseUp(SHORT button, SHORT shift, OLE_XPOS_PIXELS x, OLE_YPOS_PIXELS y)
	{
		...
		for(int i = 0; i < m_vec.GetSize(); ++i) {
			...
			if(pConnection) {
				...
				// invoke the event
				DISPPARAMS params = {p, NULL, 4, 0};
				hr = pConnection->Invoke(DISPID_FRME_MOUSEUP, IID_NULL, LOCALE_USER_DEFAULT, DISPATCH_METHOD, &params, NULL, NULL, NULL);
			}
		}
		return hr;
	}
	...
	///
	/// \if UNICODE
	///   \sa BtnCtlsLibU::_IFrameEvents::OLEDragDrop, Frame::Raise_OLEDragDrop, Fire_OLEDragEnter,
	///       Fire_OLEDragMouseMove, Fire_OLEDragLeave, Fire_MouseUp
	/// \else
	///   \sa BtnCtlsLibA::_IFrameEvents::OLEDragDrop, Frame::Raise_OLEDragDrop, Fire_OLEDragEnter,
	///       Fire_OLEDragMouseMove, Fire_OLEDragLeave, Fire_MouseUp
	/// \endif
	HRESULT Fire_OLEDragDrop(IOLEDataObject* pData, OLEDropEffectConstants* pEffect, SHORT button, SHORT shift, OLE_XPOS_PIXELS x, OLE_YPOS_PIXELS y)
	{
		...
		for(int i = 0; i < m_vec.GetSize(); ++i) {
			...
			if(pConnection) {
				...
				hr = pConnection->Invoke(DISPID_FRME_OLEDRAGDROP, IID_NULL, LOCALE_USER_DEFAULT, DISPATCH_METHOD, &params, NULL, NULL, NULL);
			}
		}
		return hr;
	}
	...
	///
	/// \if UNICODE
	///   \sa BtnCtlsLibU::_IFrameEvents::OLEDragEnter, Frame::Raise_OLEDragEnter,
	///       Fire_OLEDragMouseMove, Fire_OLEDragLeave, Fire_OLEDragDrop, Fire_MouseEnter
	/// \else
	///   \sa BtnCtlsLibA::_IFrameEvents::OLEDragEnter, Frame::Raise_OLEDragEnter,
	///       Fire_OLEDragMouseMove, Fire_OLEDragLeave, Fire_OLEDragDrop, Fire_MouseEnter
	/// \endif
	HRESULT Fire_OLEDragEnter(IOLEDataObject* pData, OLEDropEffectConstants* pEffect, SHORT button, SHORT shift, OLE_XPOS_PIXELS x, OLE_YPOS_PIXELS y)
	{
		...
		for(int i = 0; i < m_vec.GetSize(); ++i) {
			...
			if(pConnection) {
				...
				// invoke the event
				DISPPARAMS params = {p, NULL, 6, 0};
				hr = pConnection->Invoke(DISPID_FRME_OLEDRAGENTER, IID_NULL, LOCALE_USER_DEFAULT, DISPATCH_METHOD, &params, NULL, NULL, NULL);
			}
		}
		return hr;
	}
	...
	///
	/// \if UNICODE
	///   \sa BtnCtlsLibU::_IFrameEvents::OLEDragLeave, Frame::Raise_OLEDragLeave,
	///       Fire_OLEDragEnter, Fire_OLEDragMouseMove, Fire_OLEDragDrop, Fire_MouseLeave
	/// \else
	///   \sa BtnCtlsLibA::_IFrameEvents::OLEDragLeave, Frame::Raise_OLEDragLeave,
	///       Fire_OLEDragEnter, Fire_OLEDragMouseMove, Fire_OLEDragDrop, Fire_MouseLeave
	/// \endif
	HRESULT Fire_OLEDragLeave(IOLEDataObject* pData, SHORT button, SHORT shift, OLE_XPOS_PIXELS x, OLE_YPOS_PIXELS y)
	{
		...
		for(int i = 0; i < m_vec.GetSize(); ++i) {
			...
			if(pConnection) {
				...
				hr = pConnection->Invoke(DISPID_FRME_OLEDRAGLEAVE, IID_NULL, LOCALE_USER_DEFAULT, DISPATCH_METHOD, &params, NULL, NULL, NULL);
			}
		}
		return hr;
	}
	...
	///
	/// \if UNICODE
	///   \sa BtnCtlsLibU::_IFrameEvents::OLEDragMouseMove, Frame::Raise_OLEDragMouseMove,
	///       Fire_OLEDragEnter, Fire_OLEDragLeave, Fire_OLEDragDrop, Fire_MouseMove
	/// \else
	///   \sa BtnCtlsLibA::_IFrameEvents::OLEDragMouseMove, Frame::Raise_OLEDragMouseMove,
	///       Fire_OLEDragEnter, Fire_OLEDragLeave, Fire_OLEDragDrop, Fire_MouseMove
	/// \endif
	HRESULT Fire_OLEDragMouseMove(IOLEDataObject* pData, OLEDropEffectConstants* pEffect, SHORT button, SHORT shift, OLE_XPOS_PIXELS x, OLE_YPOS_PIXELS y)
	{
		...
		for(int i = 0; i < m_vec.GetSize(); ++i) {
			...
			if(pConnection) {
				...
				// invoke the event
				DISPPARAMS params = {p, NULL, 6, 0};
				hr = pConnection->Invoke(DISPID_FRME_OLEDRAGMOUSEMOVE, IID_NULL, LOCALE_USER_DEFAULT, DISPATCH_METHOD, &params, NULL, NULL, NULL);
			}
		}
		return hr;
	}
	...
	///
	/// \if UNICODE
	///   \sa BtnCtlsLibU::_IFrameEvents::OwnerDraw, Frame::Raise_OwnerDraw
	/// \else
	///   \sa BtnCtlsLibA::_IFrameEvents::OwnerDraw, Frame::Raise_OwnerDraw
	/// \endif
	HRESULT Fire_OwnerDraw(OwnerDrawActionConstants requiredAction, OwnerDrawControlStateConstants controlState, LONG hDC, RECTANGLE* pDrawingRectangle)
	{
		...
		for(int i = 0; i < m_vec.GetSize(); ++i) {
			...
			if(pConnection) {
				...
				// invoke the event
				DISPPARAMS params = {p, NULL, 4, 0};
				hr = pConnection->Invoke(DISPID_FRME_OWNERDRAW, IID_NULL, LOCALE_USER_DEFAULT, DISPATCH_METHOD, &params, NULL, NULL, NULL);
	...
	///
	/// \if UNICODE
	///   \sa BtnCtlsLibU::_IFrameEvents::RClick, Frame::Raise_RClick, Fire_ContextMenu, Fire_RDblClick,
	///       Fire_Click, Fire_MClick, Fire_XClick
	/// \else
	///   \sa BtnCtlsLibA::_IFrameEvents::RClick, Frame::Raise_RClick, Fire_ContextMenu, Fire_RDblClick,
	///       Fire_Click, Fire_MClick, Fire_XClick
	/// \endif
	HRESULT Fire_RClick(SHORT button, SHORT shift, OLE_XPOS_PIXELS x, OLE_YPOS_PIXELS y)
	{
		...
		for(int i = 0; i < m_vec.GetSize(); ++i) {
			...
			if(pConnection) {
				...
				// invoke the event
				DISPPARAMS params = {p, NULL, 4, 0};
				hr = pConnection->Invoke(DISPID_FRME_RCLICK, IID_NULL, LOCALE_USER_DEFAULT, DISPATCH_METHOD, &params, NULL, NULL, NULL);
			}
		}
		return hr;
	}
	...
	///
	/// \if UNICODE
	///   \sa BtnCtlsLibU::_IFrameEvents::RDblClick, Frame::Raise_RDblClick, Fire_RClick, Fire_DblClick,
	///       Fire_MDblClick, Fire_XDblClick
	/// \else
	///   \sa BtnCtlsLibA::_IFrameEvents::RDblClick, Frame::Raise_RDblClick, Fire_RClick, Fire_DblClick,
	///       Fire_MDblClick, Fire_XDblClick
	/// \endif
	HRESULT Fire_RDblClick(SHORT button, SHORT shift, OLE_XPOS_PIXELS x, OLE_YPOS_PIXELS y)
	{
		...
		for(int i = 0; i < m_vec.GetSize(); ++i) {
			...
			if(pConnection) {
				...
				// invoke the event
				DISPPARAMS params = {p, NULL, 4, 0};
				hr = pConnection->Invoke(DISPID_FRME_RDBLCLICK, IID_NULL, LOCALE_USER_DEFAULT, DISPATCH_METHOD, &params, NULL, NULL, NULL);
			}
		}
		return hr;
	}
	...
	///
	/// \if UNICODE
	///   \sa BtnCtlsLibU::_IFrameEvents::RecreatedControlWindow,
	///       Frame::Raise_RecreatedControlWindow, Fire_DestroyedControlWindow
	/// \else
	///   \sa BtnCtlsLibA::_IFrameEvents::RecreatedControlWindow,
	///       Frame::Raise_RecreatedControlWindow, Fire_DestroyedControlWindow
	/// \endif
	HRESULT Fire_RecreatedControlWindow(LONG hWnd)
	{
		...
		for(int i = 0; i < m_vec.GetSize(); ++i) {
			...
			if(pConnection) {
				...
				// invoke the event
				DISPPARAMS params = {p, NULL, 1, 0};
				hr = pConnection->Invoke(DISPID_FRME_RECREATEDCONTROLWINDOW, IID_NULL, LOCALE_USER_DEFAULT, DISPATCH_METHOD, &params, NULL, NULL, NULL);
			}
		}
		return hr;
	}
	...
	///
	/// \if UNICODE
	///   \sa BtnCtlsLibU::_IFrameEvents::ResizedControlWindow, Frame::Raise_ResizedControlWindow
	/// \else
	///   \sa BtnCtlsLibA::_IFrameEvents::ResizedControlWindow, Frame::Raise_ResizedControlWindow
	/// \endif
	HRESULT Fire_ResizedControlWindow(void)
	{
		...
		for(int i = 0; i < m_vec.GetSize(); ++i) {
			...
			if(pConnection) {
				...
				hr = pConnection->Invoke(DISPID_FRME_RESIZEDCONTROLWINDOW, IID_NULL, LOCALE_USER_DEFAULT, DISPATCH_METHOD, &params, NULL, NULL, NULL);
			}
		}
		return hr;
	}
	...
	///
	/// \if UNICODE
	///   \sa BtnCtlsLibU::_IFrameEvents::XClick, Frame::Raise_XClick, Fire_XDblClick, Fire_Click,
	///       Fire_MClick, Fire_RClick
	/// \else
	///   \sa BtnCtlsLibA::_IFrameEvents::XClick, Frame::Raise_XClick, Fire_XDblClick, Fire_Click,
	///       Fire_MClick, Fire_RClick
	/// \endif
	HRESULT Fire_XClick(SHORT button, SHORT shift, OLE_XPOS_PIXELS x, OLE_YPOS_PIXELS y)
	{
		...
		for(int i = 0; i < m_vec.GetSize(); ++i) {
			...
			if(pConnection) {
				...
				// invoke the event
				DISPPARAMS params = {p, NULL, 4, 0};
				hr = pConnection->Invoke(DISPID_FRME_XCLICK, IID_NULL, LOCALE_USER_DEFAULT, DISPATCH_METHOD, &params, NULL, NULL, NULL);
			}
		}
		return hr;
	}
	...
	///
	/// \if UNICODE
	///   \sa BtnCtlsLibU::_IFrameEvents::XDblClick, Frame::Raise_XDblClick, Fire_XClick, Fire_DblClick,
	///       Fire_MDblClick, Fire_RDblClick
	/// \else
	///   \sa BtnCtlsLibA::_IFrameEvents::XDblClick, Frame::Raise_XDblClick, Fire_XClick, Fire_DblClick,
	///       Fire_MDblClick, Fire_RDblClick
	/// \endif
	HRESULT Fire_XDblClick(SHORT button, SHORT shift, OLE_XPOS_PIXELS x, OLE_YPOS_PIXELS y)
	{
		...
		for(int i = 0; i < m_vec.GetSize(); ++i) {
			...
			if(pConnection) {
				...
				// invoke the event
				DISPPARAMS params = {p, NULL, 4, 0};
				hr = pConnection->Invoke(DISPID_FRME_XDBLCLICK, IID_NULL, LOCALE_USER_DEFAULT, DISPATCH_METHOD, &params, NULL, NULL, NULL);
			}
		}
		return hr;
	}
